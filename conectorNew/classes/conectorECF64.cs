...
namespace conectorBema64
{
    class conectorECF64
    {
        public conectorECF64()
        {
            Erros = "";
        }
...
if (ST3 >= 18)
    ...
    if (ST3 >= 19)
    {
        ...
        public static void Analisa_iRetorno(int IRetorno, ref string messagem)
        {
            ...
            switch (IRetorno)
            {
                ...
                case -3:
                    ...
                    break;
                case -4:
                    MSG = "Arquivo BemaFI64.INI não encontrado. Verifique!";
                    break;
                case -5:
                ...
                case -6:
                    ...
                    break;
                case -7:
                    MSG = "Banco Não Cadastrado no Arquivo BemaFI64.ini";
                    break;
                case -8:
        ...
        #region  IMPORT DAS FUNÇÕES DA BEMAFI64.DLL
        /*
		 ===============================================================================
			********************************************************************************
        ...
        /*
		 ===============================================================================
			********************************************************************************
								...
								DECLARAÇÃO DAS FUNÇÕES DA BemaFI64.DLL
		...
		*/
        ...
        //Public Declare Function Bematech_FI_EspelhoMFD Lib “BemaFI64.DLL” ( ByVal cNomeArquivoDestino As String, ByVal cDadoInicial As String, ByVal cDadoFinal As String, ByVal cTipoDownload As String, ByVal cUsuario As String, ByVal cChavePublica As String, ByVal cChavePrivada As String ) As Integer
        [DllImport("BemaFI64.dll")]
        ...
        /// <summary>
        /// Inclui o nome da cidade e do favorecido no arquivo de configuração BemaFI64.INI.
        /// </summary>
        ...
        /*Aperto ===> Public Declare Function Bematech_FI_GeraRegistrosSpedCompleto Lib "BemaFI64.DLL" 
