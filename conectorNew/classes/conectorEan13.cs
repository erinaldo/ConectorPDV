...
namespace conectorPDV001
{
    class conectorEan13
    {
        ...
        public conectorEan13()
        {

        }

        public string extraiPrdConector(System.Text.StringBuilder prd)
        {
            if (prd.Length == 13)
            {
                return prd.ToString(7, 5);
            }
            else
            {
                return prd.ToString();
        ...
        public string geraEAN(string country, string codFabrica, string prd)
        {
            System.Text.StringBuilder sbjoin = new System.Text.StringBuilder();
            this.CountryCode = country;
            this.ManufacturerCode = codFabrica;
            this.ProductCode = prd;
            this.CalculateChecksumDigit();
            sbjoin.AppendFormat("{0}{1}{2}{3}",
                                    this.CountryCode,
        ...
        public conectorEan13(string mfgNumber, string productId)
        {
            this.CountryCode = "00";
        ...
        public conectorEan13(string countryCode, string mfgNumber, string productId)
        {
        ...
        public conectorEan13(string countryCode, string mfgNumber, string productId, string checkDigit)
        {
            this.CountryCode = countryCode;
            this.ManufacturerCode = mfgNumber;
            this.ProductCode = productId;
        ...
        public System.Drawing.Bitmap CreateBitmap(string codigo)
        {
            ...
            //System.Drawing.Bitmap bmp = new System.Drawing.Bitmap(100, 40);
            bmp.SetResolution(86, 86);
