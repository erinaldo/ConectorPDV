        ...
        public static void atualizaRetorno(int iRetorno, string funcName)
        {
            ...
            else
            {
                ...
                if (szEstadoImpressora.Substring(8, 1) == "1")	//Posição 9
                    T2 = T2 + "Aguardando inserção do papel - ";

                if (szEstadoImpressora.Substring(9, 1) == "1")	//Posição 10
                    T2 = T2 + "Sensor inferior da estação de cheque Acionado - ";

                if (szEstadoImpressora.Substring(10, 1) == "1")	//Posição 11
                    T2 = T2 + "Sensor superior da estação do cheque Acionado - ";

                if (szEstadoImpressora.Substring(11, 1) == "1")	//Posição 12
                    T2 = T2 + "Sensor de autenticação Acionado - ";
                ...
                if (szEstadoFiscal.Substring(0, 2) == "00")		//Posição 1 e 2
                    ...
                    T3 = T3 + "Modo manufatura (Não-Fiscalizado) - ";
