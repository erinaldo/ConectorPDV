...
namespace conector
{
    public class geraNFe
    {
        ...
        public void geraNotaFiscalEletronica(Int16 tipoMetodo,
            ...
            List<dadosAssinatura> listaAssinatura)
        {
            ...
            dadosEnvioNfeLote EnvioNfeLote = new dadosEnvioNfeLote(null);
            #endregion
            ...
            try
            {
                ...
                dadosChaveAcessoNfe chaveAcessoNfe = new dadosChaveAcessoNfe("02", DateTime.Today.Year.ToString().Substring(2, 2) + DateTime.Today.Month.ToString("00"), "19386573000123", "12", "123", "123456789", "1", regrasNfe.geraCodigoNumerico(), null);
                chaveAcessoGeradaNfe = regrasNfe.geraChaveAcesso(chaveAcessoNfe);

                // ------------------ ITENS COM VALOR PADRÃO, CALCULADOS OU GERADOS --------------
                identificacaoNfe.ide_cNF = chaveAcessoNfe.codigoNumero;
                ...
                if (tipoRequisicao == 1) //Recepção NFe
                {
                    ...
                    // ---------------------------------------------------------------- início nfeProc -- n1                
                    xmlNfeElement = xmlNfe.CreateElement("idLote");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(EnvioNfeLote.idlote, 2, 1, 15, false, null);
                    XmlNode xmlNfeNodeEnviNFe = xmlNfeElement;
                    xmlNfeNode.AppendChild(xmlNfeNodeEnviNFe);
                    xmlNfe.AppendChild(xmlNfeNode);
                    // ---------------------------------------------------------------- fim
                }
                ...
                for (int i = 0; i < contadorGlobal; i++)
                {
                    ...
                    xmlNfeElement.SetAttribute("id", "NFe" + chaveAcessoNfe); //Id -- A03 - Atributo
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("cUF");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_cUF, 2, 2, 2, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_natOp, 2, 1, 60, false, null);
                    ...
                    if (regrasNfe.verificaIndPag(identificacaoNfe.ide_indPag))
                    {
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_indPag, 2, 1, 1, false, null);
                    ...
                    {
                        xmlNfeElement = xmlNfe.CreateElement("mod");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_mod, 2, 1, 2, false, null);
                    ...
                    {
                        xmlNfeElement = xmlNfe.CreateElement("serie");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_serie, 2, 1, 3, true, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_nNF, 2, 1, 9, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_dhEmi, 4, null, null, false, null);
                    ...
                    if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                    {
                        if (regrasNfe.verificaCampoVazio(identificacaoNfe.ide_dhSaiEnt))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_dhSaiEnt, 4, null, null, false, null);
                    ...
                    if (regrasNfe.verificaOperacaoExterior(identificacaoNfe.ide_idDest))
                    ...
                    if (regrasNfe.verificaMunicipioEstado(identificacaoNfe.ide_cMunFG, identificacaoNfe.ide_cUF) || identificacaoNfe.ide_cMunFG.Equals(regrasNfe.preencheCodigoMunicipioExterior()))
                    {
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_cMunFG, 2, 1, 7, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_verProc, 2, 1, 20, false, null);
                    ...
                    if (regrasNfe.verificaGrupoIdentificacaoNFe(identificacaoNfe.ide_dhCont, identificacaoNfe.ide_xJust))
                    {
                        ...
                        {
                            // ---------------------------------------------------------------- inicio dhCont -- B28 - f-B27.1
                            xmlNfeElement = xmlNfe.CreateElement("dhCont");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_dhCont, 4, null, null, false, null);
                            XmlNode xmlNfeNodeDhCont = xmlNfeElement;
                            xmlNfeNodeXB27.AppendChild(xmlNfeNodeDhCont);
                            xmlNfe.AppendChild(xmlNfeNode);
                            //----------------------------------------------------------------- fim

                            // ---------------------------------------------------------------- inicio xJust -- B29 - f-B27.1
                            xmlNfeElement = xmlNfe.CreateElement("xJust");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(identificacaoNfe.ide_xJust, 2, 15, 256, false, null);
                            XmlNode xmlNfeNodeXJust = xmlNfeElement;
                            xmlNfeNodeXB27.AppendChild(xmlNfeNodeXJust);
                            xmlNfe.AppendChild(xmlNfeNode);
                            //----------------------------------------------------------------- fim
                        }
                    }
                        ...
                        if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                        {
                            if (regrasNfe.verificaFinalidadeEmissaoComplementar(identificacaoNfe.ide_finNFe))
                            {
                                ...
                                if (regrasNfe.verificaTipoModelo(documentoFiscalDiferenciado.ide_nFref_refNfe_refNF_cUF, documentoFiscalDiferenciado.ide_nFref_refNfe_refNF_CNPJ))
                                {
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("cUF");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNF_cUF, 2, 2, 2, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNF_CNPJ, 2, 14, 14, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("mod");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNF_mod, 2, 2, 2, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("nNF");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNF_nNF, 2, 1, 9, false, null);
                                ...
                                if (regrasNfe.verificaTipoModelo(documentoFiscalDiferenciado.ide_nFref_refNfe_refNFP_cUF, documentoFiscalDiferenciado.ide_nFref_refNfe_refNFP_CNPJ))
                                {
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("cUF");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNFP_cUF, 2, 2, 2, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNFP_CNPJ, 2, 14, 14, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("CPF");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNFP_CPF, 2, 11, 11, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("IE");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNFP_IE, 2, 2, 14, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("nNF");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refNFP_nNF, 2, 1, 6, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refECF_nECF, 2, 3, 3, true, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(documentoFiscalDiferenciado.ide_nFref_refNfe_refECF_nCOO, 2, 3, 3, true, null);
                    ...
                    {
                        xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_CNPJ, 2, 14, 14, false, null);
                    ...
                    {
                        xmlNfeElement = xmlNfe.CreateElement("CPF");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_CPF, 2, 11, 11, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_xNome, 2, 2, 60, false, null);
                    ...
                    if (regrasNfe.verificaCampoVazio(IdentificacaoEmitenteNfe.emit_xFant))
                    {
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_xFant, 2, 1, 60, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_xLgr, 2, 1, 60, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_nro, 2, 1, 60, false, null);
                    ...
                    if (regrasNfe.verificaCampoVazio(IdentificacaoEmitenteNfe.emit_enderEmi_xCpl))
                    {
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_xCpl, 2, 1, 60, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_xBairro, 2, 2, 60, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_cMun, 2, 7, 7, true, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_xMun, 2, 2, 60, false, null);
                    ...
                    // ---------------------------------------------------------------- inicio UF -- C12 - f-C05
                    xmlNfeElement = xmlNfe.CreateElement("UF");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_UF, 2, 2, 2, false, null);
                    ...
                    if (regrasNfe.verificaCampoVazio(IdentificacaoEmitenteNfe.emit_enderEmi_fone))
                    {
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_fone, 2, 6, 14, false, null);
                    ...
                    // ---------------------------------------------------------------- inicio IE -- C17 - f-C01
                    xmlNfeElement = xmlNfe.CreateElement("IE");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_IE, 2, 2, 14, false, null);
                    ...
                    if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                    {
                        if (regrasNfe.verificaCampoVazio(IdentificacaoEmitenteNfe.emit_enderEmi_IEST))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_IEST, 2, 2, 14, false, null);
                    ...
                    if (regrasNfe.verificaEnderecoEmitenteNFeConjulgada(IdentificacaoEmitenteNfe.emit_enderEmi_IM, IdentificacaoEmitenteNfe.emit_enderEmi_CRT))
                    {
                        ...
                        // ---------------------------------------------------------------- inicio IM -- C19 - f-C18.1
                        xmlNfeElement = xmlNfe.CreateElement("IM");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoEmitenteNfe.emit_enderEmi_IM, 2, 1, 15, false, null);
                        XmlNode xmlNfeNodeIM = xmlNfeElement;
                        xmlNfeNodeXC18.AppendChild(xmlNfeNodeIM);
                        xmlNfe.AppendChild(xmlNfeNode);
                        //----------------------------------------------------------------- fim

                        // ---------------------------------------------------------------- inicio CNAE -- C20 - f-C18.1
                        if (regrasNfe.verificaIscricaoMunicipalInformada(IdentificacaoEmitenteNfe.emit_enderEmi_IM))
                        {
                            if (regrasNfe.verificaCnae(IdentificacaoEmitenteNfe.emit_enderEmi_CNAE))
                            {
                                ...
                                xmlNfeNodeXC18.AppendChild(xmlNfeNodeCNAE);
                                xmlNfe.AppendChild(xmlNfeNode);
                            }
                        }
                        //----------------------------------------------------------------- fim

                        // ---------------------------------------------------------------- inicio CRT -- C21 - f-C01
                    ...
                    if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                    {
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_CNPJ, 2, 14, 14, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("CPF");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_CPF, 2, 11, 11, false, null);
                        ...
                        if (regrasNfe.verificaIdEstrangeiro(IdentificacaoDestinatarioNfe.dest_idEstrangeiro, IdentificacaoDestinatarioNfe.dest_enderDest_cPais))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_idEstrangeiro, 2, 5, 20, false, null);
                        ...
                        if (regrasNfe.verificaNomeDestinarario(IdentificacaoDestinatarioNfe.dest_xNome, identificacaoNfe.ide_mod))
                        {
                            xmlNfeElement = xmlNfe.CreateElement("xNome");
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("xLgr");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_xLgr, 2, 2, 60, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("nro");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_nro, 2, 1, 60, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("xCpl");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_xCpl, 2, 1, 60, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("xBairro");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_xBairro, 2, 2, 60, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("cPais");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_cPais, 2, 2, 4, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("xPais");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_xPais, 2, 2, 60, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("fone");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_fone, 2, 6, 14, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("IM");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_IM, 2, 1, 15, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(IdentificacaoDestinatarioNfe.dest_enderDest_email))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoDestinatarioNfe.dest_enderDest_email, 2, 1, 60, false, null);
                        ...
                        IdentificacaoLocalRetirada.retirada_nro, IdentificacaoLocalRetirada.retirada_xBairro, IdentificacaoLocalRetirada.retirada_cMun))
                    {
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_CNPJ, 2, 14, 14, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("CPF");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_CPF, 2, 11, 11, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("xLgr");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_xLgr, 2, 2, 60, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("nro");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_nro, 2, 1, 60, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("xCpl");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_xCpl, 2, 1, 60, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("xBairro");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_xBairro, 2, 2, 60, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("cMun");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_cMun, 2, 7, 7, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("xMun");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_xMun, 2, 2, 60, false, null);
                        ...
                        // ---------------------------------------------------------------- inicio UF -- F09 - f-F01
                        xmlNfeElement = xmlNfe.CreateElement("UF");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalRetirada.retirada_UF, 2, 2, 2, false, null);
                        ...
                        IdentificacaoLocalEntrega.entrega_nro, IdentificacaoLocalEntrega.entrega_xBairro, IdentificacaoLocalEntrega.entrega_cMun))
                    {
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_CNPJ, 2, 14, 14, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("CPF");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_CPF, 2, 11, 11, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("xLgr");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_xLgr, 2, 2, 6, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("nro");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_nro, 2, 1, 60, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("xCpl");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_xCpl, 2, 1, 60, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("xBairro");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_xBairro, 2, 2, 60, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("cMun");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_cMun, 2, 7, 7, false, null);
                        ...
                        xmlNfeElement = xmlNfe.CreateElement("xMun");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_xMun, 2, 2, 60, false, null);
                        ...
                        // ---------------------------------------------------------------- inicio UF -- G09 - f-G01
                        xmlNfeElement = xmlNfe.CreateElement("UF");
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(IdentificacaoLocalEntrega.entrega_UF, 2, 2, 2, false, null);
                    ...
                    for (int j = 0; j < listaAutorizacaoObterXml.Count; j++)
                    {
                        if (listaAutorizacaoObterXml[j].flagNumeroNota == i && contador <= 10)
                        {
                            ...
                            if (regrasNfe.verificaCampoVazio(AutorizacaoObterXml.autXML_CNPJ) && regrasNfe.verificaCampoVazio(AutorizacaoObterXml.autXML_CPF))
                            {
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(AutorizacaoObterXml.autXML_CNPJ, 2, 14, 14, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("CPF");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(AutorizacaoObterXml.autXML_CPF, 2, 11, 11, false, null);
                    ...
                    for (int j = 0; j < listaDetalhamentoProdutosNfe.Count; j++)
                    {
                        ...
                        if (listaDetalhamentoProdutosNfe[j].flagNumeroNota == i)
                        {
                            ...
                            DetalhamentoProdutosNfe = listaDetalhamentoProdutosNfe[i];
                            // ---------------------------------------------------------------- inicio det -- H01 - f-A01
                            xmlNfeElement = xmlNfe.CreateElement("det");
                            xmlNfeElement.SetAttribute(null, "nItem", regrasNfe.verificaNumeroItem(DetalhamentoProdutosNfe.det_nItem) ? DetalhamentoProdutosNfe.det_nItem : ""); //nItem -- H02 - f-H01
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_cProd, 2, 1, 60, false, null);
                            ...
                            // ---------------------------------------------------------------- inicio xProd -- nI04 - f-I01
                            xmlNfeElement = xmlNfe.CreateElement("xProd");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_xProd, 2, 1, 120, false, null);
                            ...
                            {
                                if (regrasNfe.verificaImpostoProdutoInsdustrializadoNcm(ImpostoProdutosIndustrializados, ProdutosServicosNfe.prod_NCM))
                                {
                            ...
                            if (regrasNfe.verificaCampoVazio(ProdutosServicosNfe.prod_NVE))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_NVE, 2, 1, 8, false, null);
                            ...
                            if (regrasNfe.verificaCampoVazio(ProdutosServicosNfe.prod_EXTIPI))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_EXTIPI, 2, 2, 3, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_CFOP, 2, 4, 4, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_uCom, 2, 1, 6, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_qCom, 2, 0, 4, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_vUnCom, 2, 0, 10, false, null);
                            ...
                            if (regrasNfe.verificaCodigoEan(ProdutosServicosNfe.prod_cEANTrib))
                            {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_uTrib, 2, 1, 6, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_qTrib, 2, 0, 4, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosNfe.prod_vUnTrib, 2, 0, 10, false, null);
                            ...
                            for (int y = 0; y < listaProdutosServicosDeclaracaoImportacao.Count; y++)
                            {
                                ...
                                if (listaProdutosServicosDeclaracaoImportacao[y].numeroItem.Equals(DetalhamentoProdutosNfe.det_nItem))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_nDI, 2, 1, 12, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_dDI, 3, null, null, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_xLocDesemb, 2, 1, 60, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_UFDesemb, 2, 2, 2, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_dDesemb, 3, null, null, false, null);
                                    ...
                                    if (regrasNfe.verificaTipoTransporteInternacional(ProdutosServicosDeclaracaoImportacao.DI_tpViaTransp))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_tpViaTransp, 2, 2, 2, true, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_CNPJ, 2, 14, 14, false, null);
                                    ...
                                    if (regrasNfe.verificaCnpjObrigatorioDeclaracaoImportacao(ProdutosServicosDeclaracaoImportacao.DI_tpIntermedio) || regrasNfe.verificaCampoVazio(ProdutosServicosDeclaracaoImportacao.DI_UFTerceiro))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_UFTerceiro, 2, 2, 2, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_cExportador, 2, 1, 60, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_adi_nAdicao, 2, 1, 3, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_adi_nSeqAdicC, 2, 1, 3, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_adi_cFabricante, 2, 1, 60, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ProdutosServicosDeclaracaoImportacao.DI_adi_nDraw))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosDeclaracaoImportacao.DI_adi_nDraw, 2, 11, 11, false, null);
                            ...
                            if (regrasNfe.verificaDrawbackInformado(ProdutosServicosGrupoExportacao.detExport_nDraw))
                            {
                                for (int q = 0; q < listaProdutosServicosGrupoExportacao.Count; q++)
                                {
                                    if (listaProdutosServicosGrupoExportacao[q].numeroItem.Equals(DetalhamentoProdutosNfe.det_nItem))
                                    {
                                        ...
                                        {
                                            xmlNfeElement = xmlNfe.CreateElement("nDraw");
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosGrupoExportacao.detExport_nDraw, 2, 11, 11, false, null);
                                        ...
                                        if (regrasNfe.verificaGrupoExportacaoIndireta(ProdutosServicosGrupoExportacao.detExport_exportInd_nRE, ProdutosServicosGrupoExportacao.detExport_exportInd_chNFe, ProdutosServicosGrupoExportacao.detExport_exportInd_qExport))
                                        {
                                            ...
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosGrupoExportacao.detExport_exportInd_nRE, 2, 12, 12, false, null);
                                            ...
                                            xmlNfeElement = xmlNfe.CreateElement("chNFe");
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosGrupoExportacao.detExport_exportInd_chNFe, 2, 44, 44, false, null);
                            ...
                            if (regrasNfe.verificaCampoVazio(ProdutosServicosPedidoCompra.DI_xPed))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosPedidoCompra.DI_xPed, 2, 1, 15, false, null);
                            ...
                            if (regrasNfe.verificaCampoVazio(ProdutosServicosPedidoCompra.DI_nItemPed))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosPedidoCompra.DI_nItemPed, 2, 6, 6, false, null);
                            ...
                            if (regrasNfe.verificaCampoVazio(ProdutosServicosGrupoDiversos.DI_nFCI))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ProdutosServicosGrupoDiversos.DI_nFCI, 2, 36, 36, false, null);
                            ...
                            if (regrasNfe.verificaPreenchimentoVeiculosNovos(DetalhamentoEspecificoVeiculosNovos))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_chassi, 2, 14, 14, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_xCor, 2, 1, 40, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_pot, 2, 1, 4, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_cilin, 2, 1, 4, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_pesoL, 2, 1, 9, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_pesoB, 2, 1, 9, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_nSerie, 2, 1, 9, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_tpComb, 2, 1, 2, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_nMotor, 2, 1, 21, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_CMT, 2, 1, 9, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_dist, 2, 1, 4, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_anoMod, 2, 4, 4, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_anoFab, 2, 4, 4, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_tpPint, 2, 1, 1, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_tpVeic, 2, 1, 2, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_cMod, 2, 1, 6, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoVeiculosNovos.veicProd_lota, 2, 1, 3, false, null);
                            ...
                            if (regrasNfe.verificaDetalhamentoEspecificoMedicamento(DetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas))
                            {
                                for (int w = 0; w < listaDetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas.Count; w++)
                                {
                                    ...
                                    if (listaDetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas[w].numeroItem.Equals(DetalhamentoProdutosNfe.det_nItem))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas.med_nLote, 2, 1, 20, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas.med_qLote, 2, 1, 8, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas.med_dFab, 3, null, null, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas.med_dVal, 3, null, null, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas.med_vPMC, 2, 1, 13, false, null);
                            ...
                            if (regrasNfe.verificaDetalhamentoEspecificoArmamentos(DetalhamentoEspecificoArmamentos))
                            {
                                for (int e = 0; e < listaDetalhamentoEspecificoArmamentos.Count; e++)
                                {
                                    ...
                                    if (listaDetalhamentoEspecificoArmamentos[e].numeroItem.Equals(DetalhamentoProdutosNfe.det_nItem))
                                    {
                                        ...
                                        xmlNfeElement = xmlNfe.CreateElement("nSerie");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoArmamentos.arma_nSerie, 2, 1, 15, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoArmamentos.arma_nCano, 2, 1, 15, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoArmamentos.arma_descr, 2, 1, 256, false, null);
                            ...
                            if (regrasNfe.verificaDetalhamentoEspecificoCombustiveis(DetalhamentoEspecificoCombustiveis))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoCombustiveis.comb_cProdANP, 2, 9, 9, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(DetalhamentoEspecificoCombustiveis.comb_pMixGN))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoCombustiveis.comb_pMixGN, 2, 7, 7, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(DetalhamentoEspecificoCombustiveis.comb_CODIF))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoCombustiveis.comb_CODIF, 2, 1, 21, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(DetalhamentoEspecificoCombustiveis.comb_qTemp))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoCombustiveis.comb_qTemp, 2, 1, 17, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoCombustiveis.comb_UFCons, 2, 2, 2, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoCombustiveis.comb_CIDE_qBCProd, 2, 1, 17, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoCombustiveis.comb_CIDE_vAliqProd, 2, 1, 16, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoCombustiveis.comb_CIDE_vCIDE, 2, 1, 16, false, null);
                            ...
                            if (regrasNfe.verificaDetalhamentoEspecificoOperacaoPapelImune(DetalhamentoEspecificoOperacaoPapelImune))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DetalhamentoEspecificoOperacaoPapelImune.nRECOPI, 2, 20, 20, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TributosIncidentesProdutoServico.imposto_vTotTrib, 2, 1, 16, false, null);
                            ...
                            if (!regrasNfe.verificaIssqn(ISSQN))
                            {
                                ...
                                if (regrasNfe.verificaIcms("00", ICMSNormalST.ICMS_ICMS00_CST))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS00_vBC, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS00_pICMS, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS00_vICMS, 2, 1, 16, false, null);
                                ...
                                if (regrasNfe.verificaIcms("10", ICMSNormalST.ICMS_ICMS10_CST))
                                {
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS10_vBC, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS10_pICMS, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS10_vICMS, 2, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMS10_pMVAST))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS10_pMVAST, 2, 1, 8, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMS10_pRedBCST))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS10_pRedBCST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS10_vBCST, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS10_pICMSST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS10_vICMSST, 2, 1, 16, false, null);
                                ...
                                if (regrasNfe.verificaIcms("20", ICMSNormalST.ICMS_ICMS20_CST))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS20_pRedBC, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS20_vBC, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS20_pICMS, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS20_vICMS, 2, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaMotivoDesoneracaoIcms20(ICMSNormalST.ICMS_ICMS20_motDesICMS))
                                    {
                                        ...
                                        // ---------------------------------------------------------------- inicio vICMSDeson -- N27a - f-N27.1
                                        xmlNfeElement = xmlNfe.CreateElement("vICMSDeson");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS20_vICMSDeson, 2, 1, 16, false, null);
                                        XmlNode xmlNfeNodeXN27_1_1vICMSDeson = xmlNfeElement;
                                        xmlNfeNodeXN27_1_1.AppendChild(xmlNfeNodeXN27_1_1vICMSDeson);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim

                                        // ---------------------------------------------------------------- inicio vICMSDeson -- N28 - f-N27.1
                                        xmlNfeElement = xmlNfe.CreateElement("motDesICMS");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS20_motDesICMS, 2, 1, 2, false, null);
                                        XmlNode xmlNfeNodeXN27_1_1motDesICMS = xmlNfeElement;
                                        xmlNfeNodeXN27_1_1.AppendChild(xmlNfeNodeXN27_1_1motDesICMS);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                    }
                                }
                                ...
                                if (regrasNfe.verificaIcms("30", ICMSNormalST.ICMS_ICMS30_CST))
                                {
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pMVAST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS30_pMVAST, 2, 1, 8, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBCST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS30_pRedBCST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBCST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS30_vBCST, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS30_pICMSST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS30_vICMSST, 2, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaMotivoDesoneracaoIcms30(ICMSNormalST.ICMS_ICMS30_motDesICMS))
                                    {
                                        ...
                                        xmlNfeNodeXN27_1_2.AppendChild(xmlNfeNodeXN27_1_2VICMSDeson);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim

                                        // ---------------------------------------------------------------- inicio motDesICMS -- N28 - f-N27.1
                                        xmlNfeElement = xmlNfe.CreateElement("motDesICMS");
                                        xmlNfeElement.InnerText = ICMSNormalST.ICMS_ICMS30_motDesICMS;
                                        XmlNode xmlNfeNodeXN27_1_2MotDesICMS = xmlNfeElement;
                                        xmlNfeNodeXN27_1_2.AppendChild(xmlNfeNodeXN27_1_2MotDesICMS);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                    }
                                }
                                ...
                                if (regrasNfe.verificaIcms("40", ICMSNormalST.ICMS_ICMS40_CST) || regrasNfe.verificaIcms("41", ICMSNormalST.ICMS_ICMS40_CST) || regrasNfe.verificaIcms("50", ICMSNormalST.ICMS_ICMS40_CST))
                                {
                                    ...
                                    if (regrasNfe.verificaMotivoDesoneracaoIcms40(ICMSNormalST.ICMS_ICMS40_motDesICMS))
                                    {
                                        ...
                                        xmlNfeNodeX127_1_3.AppendChild(xmlNfeNodeX127_1_3vICMSDeson);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                        ...
                                        xmlNfeNodeX127_1_3.AppendChild(xmlNfeNodeX127_1_3motDesICMS);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                    }
                                }
                                ...
                                if (regrasNfe.verificaIcms("51", ICMSNormalST.ICMS_ICMS51_CST))
                                {
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBC");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS51_pRedBC, 2, 1, 8, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("vBC");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS51_vBC, 2, 1, 16, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pICMS");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS51_pICMS, 2, 1, 8, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMS51_vICMSOp))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS51_vICMSOp, 2, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMS51_pDif))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS51_pDif, 2, 1, 8, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMS51_vICMSDif))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS51_vICMSDif, 2, 1, 16, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("vICMS");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS51_vICMS, 2, 1, 16, false, null);
                                ...
                                if (regrasNfe.verificaIcms("60", ICMSNormalST.ICMS_ICMS60_CST))
                                {
                                    ...
                                    if (regrasNfe.verificaSequenciaIcms60(ICMSNormalST.ICMS_ICMS60_vBCSTRet, ICMSNormalST.ICMS_ICMS60_vICMSSTRet))
                                    {
                                        ...
                                        // ---------------------------------------------------------------- inicio vBCSTRet -- N26 - f-N25.1
                                        xmlNfeElement = xmlNfe.CreateElement("vBCSTRet");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS60_vBCSTRet, 2, 1, 16, false, null);
                                        XmlNode xmlNfeNodeX25_1vBCSTRet = xmlNfeElement;
                                        xmlNfeNodeX25_1.AppendChild(xmlNfeNodeX25_1vBCSTRet);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim

                                        // ---------------------------------------------------------------- inicio vICMSSTRet -- N27 - f-N25.1
                                        xmlNfeElement = xmlNfe.CreateElement("vICMSSTRet");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS60_vICMSSTRet, 2, 1, 16, false, null);
                                        XmlNode xmlNfeNodeX25_1vICMSSTRet = xmlNfeElement;
                                        xmlNfeNodeX25_1.AppendChild(xmlNfeNodeX25_1vICMSSTRet);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                    }
                                }
                                ...
                                if (regrasNfe.verificaIcms("70", ICMSNormalST.ICMS_ICMS70_CST))
                                {
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pRedBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_pRedBC, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_vBC, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_pICMS, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_vICMS, 2, 1, 16, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pMVAST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_pMVAST, 2, 1, 8, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBCST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_pRedBCST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBCST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_vBCST, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_pICMSST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_vICMSST, 2, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaSequenciaIcms70Desonerado(ICMSNormalST.ICMS_ICMS70_motDesICMS))
                                    {
                                        ...
                                        // ---------------------------------------------------------------- inicio vICMSDeson -- N27a - f-N27.1
                                        xmlNfeElement = xmlNfe.CreateElement("vICMSDeson");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_vICMSDeson, 2, 1, 16, false, null);
                                        XmlNode xmlNfeNodeXN27_1_3vICMSDeson = xmlNfeElement;
                                        xmlNfeNodeXN27_1_3.AppendChild(xmlNfeNodeXN27_1_3vICMSDeson);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim

                                        // ---------------------------------------------------------------- inicio motDesICMS -- N28 - f-N27.1
                                        xmlNfeElement = xmlNfe.CreateElement("motDesICMS");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS70_motDesICMS, 2, 1, 2, true, null);
                                        XmlNode xmlNfeNodeXN27_1_3motDesICMS = xmlNfeElement;
                                        xmlNfeNodeXN27_1_3.AppendChild(xmlNfeNodeXN27_1_3motDesICMS);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                    }
                                }
                                ...
                                if (regrasNfe.verificaIcms("90", ICMSNormalST.ICMS_ICMS90_CST))
                                {
                                    ...
                                    if (regrasNfe.verificaModalidadeBaseCalculo(ICMSNormalST.ICMS_ICMS90_modBC))
                                    {
                                        ...
                                        xmlNfeNodeX12_1.AppendChild(xmlNfeNodeX12_1modBC);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    else
                                    {
                                    ...
                                    // ---------------------------------------------------------------- inicio vBC -- N15 - f-N12.1
                                    xmlNfeElement = xmlNfe.CreateElement("vBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_vBC, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeX12_1vBC = xmlNfeElement;
                                    xmlNfeNodeX12_1.AppendChild(xmlNfeNodeX12_1vBC);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio pRedBC -- N14 - f-N12.1
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMS90_pRedBC))
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBC");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_pRedBC, 2, 1, 8, false, null);
                                        XmlNode xmlNfeNodeX12_1pRedBC = xmlNfeElement;
                                        xmlNfeNodeX12_1.AppendChild(xmlNfeNodeX12_1pRedBC);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio pICMS -- N16 - f-N12.1
                                    xmlNfeElement = xmlNfe.CreateElement("pICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_pICMS, 2, 1, 8, false, null);
                                    XmlNode xmlNfeNodeX12_1pICMS = xmlNfeElement;
                                    xmlNfeNodeX12_1.AppendChild(xmlNfeNodeX12_1pICMS);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio vICMS -- N17 - f-N12.1
                                    xmlNfeElement = xmlNfe.CreateElement("vICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_vICMS, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeX12_1vICMS = xmlNfeElement;
                                    xmlNfeNodeX12_1.AppendChild(xmlNfeNodeX12_1vICMS);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim
                                    ...
                                    if (regrasNfe.verificaModalidadeBaseCalculoST(ICMSNormalST.ICMS_ICMS90_modBCST))
                                    {
                                        ...
                                        xmlNfeNodeX17_1.AppendChild(xmlNfeNodeX17_1modBCST);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    else
                                    {
                                    ...
                                    // ---------------------------------------------------------------- inicio pMVAST -- N19 - f-N17.1
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMS90_pMVAST))
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pMVAST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_pMVAST, 2, 1, 8, false, null);
                                        XmlNode xmlNfeNodeX17_1pMVAST = xmlNfeElement;
                                        xmlNfeNodeX17_1.AppendChild(xmlNfeNodeX17_1pMVAST);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio pRedBCST -- N20 - f-N17.1
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMS90_pRedBCST))
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBCST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_pRedBCST, 2, 1, 8, false, null);
                                        XmlNode xmlNfeNodeX17_1pRedBCST = xmlNfeElement;
                                        xmlNfeNodeX17_1.AppendChild(xmlNfeNodeX17_1pRedBCST);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    //----------------------------------------------------------------- fim
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBCST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_vBCST, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeX17_1vBCST = xmlNfeElement;
                                    xmlNfeNodeX17_1.AppendChild(xmlNfeNodeX17_1vBCST);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio pICMSST -- N22 - f-N17.1
                                    xmlNfeElement = xmlNfe.CreateElement("pICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_pICMSST, 2, 1, 8, false, null);
                                    XmlNode xmlNfeNodeX17_1pICMSST = xmlNfeElement;
                                    xmlNfeNodeX17_1.AppendChild(xmlNfeNodeX17_1pICMSST);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio vICMSST -- N23 - f-N17.1
                                    xmlNfeElement = xmlNfe.CreateElement("vICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_vICMSST, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeX17_1vICMSST = xmlNfeElement;
                                    xmlNfeNodeX17_1.AppendChild(xmlNfeNodeX17_1vICMSST);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim
                                    ...
                                    if (regrasNfe.verificaSequenciaIcms90Desonerado(ICMSNormalST.ICMS_ICMS90_motDesICMS))
                                    {
                                        ...
                                        // ---------------------------------------------------------------- inicio vICMSDeson -- N27a - f-N27.1
                                        xmlNfeElement = xmlNfe.CreateElement("vICMSDeson");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMS90_vICMSDeson, 2, 1, 16, false, null);
                                        XmlNode xmlNfeNodeX27_1vICMSDeson = xmlNfeElement;
                                        xmlNfeNodeX27_1.AppendChild(xmlNfeNodeX27_1vICMSDeson);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                        ...
                                        xmlNfeNodeX27_1.AppendChild(xmlNfeNodeX27_1motDesICMS);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                    }
                                }
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("vBC");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_vBC, 2, 1, 16, false, null);
                                ...
                                {
                                    xmlNfeElement = xmlNfe.CreateElement("pRedBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_pRedBC, 2, 1, 8, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("pICMS");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_pICMS, 2, 1, 8, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("vICMS");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_vICMS, 2, 1, 16, false, null);
                                ...
                                {
                                    xmlNfeElement = xmlNfe.CreateElement("pMVAST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_pMVAST, 2, 1, 8, false, null);
                                ...
                                {
                                    xmlNfeElement = xmlNfe.CreateElement("pRedBCST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_pRedBCST, 2, 1, 8, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("vBCST");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_vBCST, 2, 1, 16, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("pICMSST");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_pICMSST, 2, 1, 8, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("vICMSST");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_vICMSST, 2, 1, 16, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_pBCOp, 2, 1, 8, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSPart_UFST, 2, 2, 2, false, null);
                                ...
                                if (regrasNfe.verificaIcms("41", ICMSNormalST.ICMS_ICMSST_CST))
                                {
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBCSTRet");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSST_vBCSTRet, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vICMSSTRet");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSST_vICMSSTRet, 1, 1, 16, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSST_vBCSTDest, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSST_vICMSSTDest, 2, 1, 16, false, null);
                                ...
                                if (regrasNfe.verificaIcms("101", ICMSNormalST.ICMS_ICMSSN101_CSOSN))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN101_pCredSN, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN101_vCredICMSSN, 2, 1, 16, false, null);
                                ...
                                if (regrasNfe.verificaIcms("201", ICMSNormalST.ICMS_ICMSSN201_CSOSN))
                                {
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pMVAST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN201_pMVAST, 2, 1, 8, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBCST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN201_pRedBCST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBCST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN201_vBCST, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN201_pICMSST, 1, 1, 8, false, null);
                                    ...
                                    // ---------------------------------------------------------------- inicio vICMSST -- N22 - f-N10e
                                    xmlNfeElement = xmlNfe.CreateElement("vICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN201_vICMSST, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pCredSN");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN201_pCredSN, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vCredICMSSN");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN201_vCredICMSSN, 2, 1, 16, false, null);
                                ...
                                if (regrasNfe.verificaIcms("202", ICMSNormalST.ICMS_ICMSSN202_CSOSN) || regrasNfe.verificaIcms("203", ICMSNormalST.ICMS_ICMSSN202_CSOSN))
                                {
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pMVAST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN202_pMVAST, 2, 1, 8, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBCST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN202_pRedBCST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vBCST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN202_vBCST, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("pICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN202_pICMSST, 2, 1, 8, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("vICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN202_vICMSST, 2, 1, 16, false, null);
                                ...
                                // ---------------------------------------------------------------- inicio vBCSTRet -- N126 - f-N25.1
                                xmlNfeElement = xmlNfe.CreateElement("vBCSTRet");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN500_vBCSTRet, 2, 1, 16, false, null);
                                XmlNode xmlNfeNodeXN25_1vBCSTRet = xmlNfeElement;
                                xmlNfeNodeXN25_1.AppendChild(xmlNfeNodeXN25_1vBCSTRet);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim

                                // ---------------------------------------------------------------- inicio vICMSSTRet -- N27 - f-N25.1
                                xmlNfeElement = xmlNfe.CreateElement("vICMSSTRet");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN500_vICMSSTRet, 2, 1, 16, false, null);
                                XmlNode xmlNfeNodeXN25_1vICMSSTRet = xmlNfeElement;
                                xmlNfeNodeXN25_1.AppendChild(xmlNfeNodeXN25_1vICMSSTRet);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim
                                ...
                                if (regrasNfe.verificaIcms("900", ICMSNormalST.ICMS_ICMSSN900_CSOSN))
                                {
                                    ...
                                    if (regrasNfe.verificaModalidadeBaseCalculo(ICMSNormalST.ICMS_ICMSSN900_modBC))
                                    {
                                        ...
                                        xmlNfeNodeX17_1_1.AppendChild(xmlNfeNodeX17_1_1modBC);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    else
                                    {
                                    ...
                                    // ---------------------------------------------------------------- inicio vBC -- N15 - f-N17.1
                                    xmlNfeElement = xmlNfe.CreateElement("vBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_vBC, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeX17_1_1vBC = xmlNfeElement;
                                    xmlNfeNodeX17_1_1.AppendChild(xmlNfeNodeX17_1_1vBC);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio pRedBC -- N14 - f-N17.1
                                    if (regrasNfe.verificaCampoVazio(ICMSNormalST.ICMS_ICMSSN900_pRedBC))
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBC");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_pRedBC, 2, 1, 8, false, null);
                                        XmlNode xmlNfeNodeX17_1_1pRedBC = xmlNfeElement;
                                        xmlNfeNodeX17_1_1.AppendChild(xmlNfeNodeX17_1_1pRedBC);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio pICMS -- N16 - f-N17.1
                                    xmlNfeElement = xmlNfe.CreateElement("pICMS");
                                    xmlNfeElement.InnerText = ICMSNormalST.ICMS_ICMSSN900_pICMS;
                                    XmlNode xmlNfeNodeX17_1_1pICMS = xmlNfeElement;
                                    xmlNfeNodeX17_1_1.AppendChild(xmlNfeNodeX17_1_1pICMS);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio vICMS -- N17 - f-N17.1
                                    xmlNfeElement = xmlNfe.CreateElement("vICMS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_vICMS, 2, 1, 8, false, null);
                                    XmlNode xmlNfeNodeX17_1_1vICMS = xmlNfeElement;
                                    xmlNfeNodeX17_1_1.AppendChild(xmlNfeNodeX17_1_1vICMS);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim
                                    ...
                                    if (regrasNfe.verificaModalidadeBaseCalculoST(ICMSNormalST.ICMS_ICMSSN900_modBCST))
                                    {
                                        ...
                                        xmlNfeNodeX17_1_2.AppendChild(xmlNfeNodeX17_1_2modBCST);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    else
                                    {
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pMVAST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_pMVAST, 2, 1, 8, false, null);
                                        XmlNode xmlNfeNodeX17_1_2pMVAST = xmlNfeElement;
                                        xmlNfeNodeX17_1_2.AppendChild(xmlNfeNodeX17_1_2pMVAST);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    //----------------------------------------------------------------- fim
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("pRedBCST");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_pRedBCST, 2, 1, 8, false, null);
                                        XmlNode xmlNfeNodeX17_1_2pRedBCST = xmlNfeElement;
                                        xmlNfeNodeX17_1_2.AppendChild(xmlNfeNodeX17_1_2pRedBCST);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                    }
                                    //----------------------------------------------------------------- fim
                                    ...
                                    // ---------------------------------------------------------------- inicio vBCST -- N21 - f-N17.1
                                    xmlNfeElement = xmlNfe.CreateElement("vBCST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_vBCST, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeX17_1_2vBCST = xmlNfeElement;
                                    xmlNfeNodeX17_1_2.AppendChild(xmlNfeNodeX17_1_2vBCST);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio pICMSST -- N22 - f-N17.1
                                    xmlNfeElement = xmlNfe.CreateElement("pICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_pICMSST, 2, 1, 8, false, null);
                                    XmlNode xmlNfeNodeX17_1_2pICMSST = xmlNfeElement;
                                    xmlNfeNodeX17_1_2.AppendChild(xmlNfeNodeX17_1_2pICMSST);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio vICMSST -- N23 - f-N17.1
                                    xmlNfeElement = xmlNfe.CreateElement("vICMSST");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_vICMSST, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeX17_1_2vICMSST = xmlNfeElement;
                                    xmlNfeNodeX17_1_2.AppendChild(xmlNfeNodeX17_1_2vICMSST);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim
                                    ...
                                    // ---------------------------------------------------------------- inicio pCredSN -- N29 - f-N27.1
                                    xmlNfeElement = xmlNfe.CreateElement("pCredSN");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_pCredSN, 2, 1, 8, false, null);
                                    XmlNode xmlNfeNodeX27_1_1pCredSN = xmlNfeElement;
                                    xmlNfeNodeX27_1_1.AppendChild(xmlNfeNodeX27_1_1pCredSN);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio vCredICMSSN -- N30 - f-N27.1
                                    xmlNfeElement = xmlNfe.CreateElement("vCredICMSSN");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ICMSNormalST.ICMS_ICMSSN900_vCredICMSSN, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeX27_1_1vCredICMSSN = xmlNfeElement;
                                    xmlNfeNodeX27_1_1.AppendChild(xmlNfeNodeX27_1_1vCredICMSSN);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim
                                }
                            }
                                ...
                                if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                                {
                                    ...
                                    if (regrasNfe.verificaIpiInformado(ImpostoProdutosIndustrializados))
                                    {
                                        ...
                                        if (regrasNfe.verificaCampoVazio(ImpostoProdutosIndustrializados.IPI_clEnq))
                                        {
                                            ...
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_clEnq, 2, 1, 5, false, null);
                                        ...
                                        if (regrasNfe.verificaCampoVazio(ImpostoProdutosIndustrializados.IPI_CNPJProd))
                                        {
                                            ...
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_CNPJProd, 2, 14, 14, false, null);
                                        ...
                                        if (regrasNfe.verificaCampoVazio(ImpostoProdutosIndustrializados.IPI_cSelo))
                                        {
                                            ...
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_cSelo, 2, 1, 60, false, null);
                                        ...
                                        if (regrasNfe.verificaCampoVazio(ImpostoProdutosIndustrializados.IPI_qSelo))
                                        {
                                            ...
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_qSelo, 2, 1, 12, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_cEnq, 2, 1, 3, false, null);
                                        ...
                                        if (regrasNfe.verificaGrupoCstIpiTributado(ImpostoProdutosIndustrializados.IPI_IPITrib_CST))
                                        {
                                            ...
                                            // ---------------------------------------------------------------- inicio vBC -- O10 - O09.1
                                            xmlNfeElement = xmlNfe.CreateElement("vBC");
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_IPITrib_vBC, 2, 1, 16, false, null);
                                            XmlNode xmlNfeNodeXO09_1vBC = xmlNfeElement;
                                            xmlNfeNodeXO09_1.AppendChild(xmlNfeNodeXO09_1vBC);
                                            xmlNfe.AppendChild(xmlNfeNode);
                                            //----------------------------------------------------------------- fim

                                            // ---------------------------------------------------------------- inicio pIPI -- O13 - O09.1
                                            xmlNfeElement = xmlNfe.CreateElement("pIPI");
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_IPITrib_vIPI, 2, 1, 8, false, null);
                                            XmlNode xmlNfeNodeXO09_1pIPI = xmlNfeElement;
                                            xmlNfeNodeXO09_1.AppendChild(xmlNfeNodeXO09_1pIPI);
                                            xmlNfe.AppendChild(xmlNfeNode);
                                            //----------------------------------------------------------------- fim
                                            ...
                                            // ---------------------------------------------------------------- inicio qUnid -- O11 - O13.1
                                            xmlNfeElement = xmlNfe.CreateElement("qUnid");
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_IPITrib_qUnid, 2, 1, 16, false, null);
                                            XmlNode xmlNfeNodeXO13_1qUnid = xmlNfeElement;
                                            xmlNfeNodeXO13_1.AppendChild(xmlNfeNodeXO13_1qUnid);
                                            xmlNfe.AppendChild(xmlNfeNode);
                                            //----------------------------------------------------------------- fim

                                            // ---------------------------------------------------------------- inicio vUnid -- O12 - O13.1
                                            xmlNfeElement = xmlNfe.CreateElement("vUnid");
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_IPITrib_vUnid, 2, 1, 15, false, null);
                                            XmlNode xmlNfeNodeXO13_1vUnid = xmlNfeElement;
                                            xmlNfeNodeXO13_1.AppendChild(xmlNfeNodeXO13_1vUnid);
                                            xmlNfe.AppendChild(xmlNfeNode);
                                            //----------------------------------------------------------------- fim

                                            // ---------------------------------------------------------------- inicio vIPI -- O14 - O13.1
                                            xmlNfeElement = xmlNfe.CreateElement("vIPI");
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoProdutosIndustrializados.IPI_IPITrib_vIPI, 2, 1, 16, false, null);
                                            XmlNode xmlNfeNodeXO13_1vIPI = xmlNfeElement;
                                            xmlNfeNodeXO13_1.AppendChild(xmlNfeNodeXO13_1vIPI);
                                            xmlNfe.AppendChild(xmlNfeNode);
                                            //----------------------------------------------------------------- fim
                                        }
                            ...
                            if (!regrasNfe.verificaIssqn(ISSQN))
                            {
                                if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                                {
                                    ...
                                    if (regrasNfe.verificaImpostoImportacaoInformado(ImpostoImportacao))
                                    {
                                        ...
                                        // ---------------------------------------------------------------- inicio vBC -- P02 - P01
                                        xmlNfeElement = xmlNfe.CreateElement("vBC");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoImportacao.II_vBC, 2, 1, 16, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoImportacao.II_vDespAdu, 2, 1, 16, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoImportacao.II_vII, 2, 1, 16, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ImpostoImportacao.II_vIOF, 2, 1, 16, false, null);
                            ...
                            // ---------------------------------------------------------------- inicio vBC -- Q07 - Q02
                            xmlNfeElement = xmlNfe.CreateElement("vBC");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISAliq_vBC, 2, 1, 16, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISAliq_pPIS, 2, 1, 8, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISAliq_vPIS, 2, 1, 16, false, null);
                            ...
                            xmlNfeElement = xmlNfe.CreateElement("qBCProd");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISQtde_qBCProd, 2, 1, 16, false, null);
                            ...
                            xmlNfeElement = xmlNfe.CreateElement("vAliqProd");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISQtde_vAliqProd, 2, 1, 16, false, null);
                            ...
                            // ---------------------------------------------------------------- inicio vPIS -- Q09 - Q03
                            xmlNfeElement = xmlNfe.CreateElement("vPIS");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISQtde_vPIS, 2, 1, 16, false, null);
                            ...
                            if (regrasNfe.verificaCalculoPisPercentual(Pis.PIS_PISOutr_vBC, Pis.PIS_PISOutr_pPIS))
                            {
                                ...
                                // ---------------------------------------------------------------- inicio vBC -- Q07 - Q06.1
                                xmlNfeElement = xmlNfe.CreateElement("vBC");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISOutr_vBC, 2, 1, 16, false, null);
                                XmlNode xmlNfeNodeXQ06_1vBC = xmlNfeElement;
                                xmlNfeNodeXQ06_1.AppendChild(xmlNfeNodeXQ06_1vBC);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim

                                // ---------------------------------------------------------------- inicio pPIS -- Q08 - Q06.1
                                xmlNfeElement = xmlNfe.CreateElement("pPIS");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISOutr_pPIS, 2, 1, 8, false, null);
                                XmlNode xmlNfeNodeXQ06_1pPIS = xmlNfeElement;
                                xmlNfeNodeXQ06_1.AppendChild(xmlNfeNodeXQ06_1pPIS);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim
                            }
                            ...
                            if (regrasNfe.verificaCalculoPisValor(Pis.PIS_PISOutr_qBCProd, Pis.PIS_PISOutr_vAliqProd, Pis.PIS_PISOutr_vPIS))
                            {
                                ...
                                // ---------------------------------------------------------------- inicio qBCProd -- Q10 - Q08.1
                                xmlNfeElement = xmlNfe.CreateElement("qBCProd");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISOutr_qBCProd, 2, 1, 17, false, null);
                                XmlNode xmlNfeNodeXQ08_1qBCProd = xmlNfeElement;
                                xmlNfeNodeXQ08_1.AppendChild(xmlNfeNodeXQ08_1qBCProd);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim

                                // ---------------------------------------------------------------- inicio vAliqProd -- Q11 - Q08.1
                                xmlNfeElement = xmlNfe.CreateElement("vAliqProd");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISOutr_vAliqProd, 2, 1, 16, false, null);
                                XmlNode xmlNfeNodeXQ08_1vAliqProd = xmlNfeElement;
                                xmlNfeNodeXQ08_1.AppendChild(xmlNfeNodeXQ08_1vAliqProd);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim

                                // ---------------------------------------------------------------- inicio vPIS -- Q09 - Q05
                                xmlNfeElement = xmlNfe.CreateElement("vPIS");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Pis.PIS_PISOutr_vPIS, 2, 1, 16, false, null);
                            ...
                            {
                                PisST = listaPisST[j];
                                if (regrasNfe.verificaPisSt(PisST))
                                {
                                    ...
                                    if (regrasNfe.verificaCalculoPisPercentual(PisST.PISST_vBC, PisST.PISST_pPIS))
                                    {
                                        ...
                                        // ---------------------------------------------------------------- inicio vBC -- R02 - R01.1
                                        xmlNfeElement = xmlNfe.CreateElement("vBC");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(PisST.PISST_vBC, 2, 1, 16, false, null);
                                        XmlNode xmlNfeNodeXR01_1vBC = xmlNfeElement;
                                        xmlNfeNodeXR01_1.AppendChild(xmlNfeNodeXR01_1vBC);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim

                                        // ---------------------------------------------------------------- inicio pPIS -- R03 - R01.1
                                        xmlNfeElement = xmlNfe.CreateElement("pPIS");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(PisST.PISST_pPIS, 2, 1, 8, false, null);
                                        XmlNode xmlNfeNodeXR01_1pPIS = xmlNfeElement;
                                        xmlNfeNodeXR01_1.AppendChild(xmlNfeNodeXR01_1pPIS);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                    }
                                    ...
                                    if (regrasNfe.verificaCalculoPisValor(PisST.PISST_qBCProd, PisST.PISST_vAliqProd, PisST.PISST_vPIS))
                                    {
                                        ...
                                        // ---------------------------------------------------------------- inicio qBCProd -- R04 - R03.1
                                        xmlNfeElement = xmlNfe.CreateElement("qBCProd");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(PisST.PISST_qBCProd, 2, 1, 17, false, null);
                                        XmlNode xmlNfeNodeXR03_1qBCProd = xmlNfeElement;
                                        xmlNfeNodeXR03_1.AppendChild(xmlNfeNodeXR03_1qBCProd);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim

                                        // ---------------------------------------------------------------- inicio vAliqProd -- R05 - R03.1
                                        xmlNfeElement = xmlNfe.CreateElement("vAliqProd");
                                        xmlNfeElement.InnerText = PisST.PISST_vAliqProd;
                                        XmlNode xmlNfeNodeXR03_1vAliqProd = xmlNfeElement;
                                        xmlNfeNodeXR03_1.AppendChild(xmlNfeNodeXR03_1vAliqProd);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim

                                        // ---------------------------------------------------------------- inicio vPIS -- R06 - R03.1
                                        xmlNfeElement = xmlNfe.CreateElement("vPIS");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(PisST.PISST_vPIS, 2, 1, 16, false, null);
                                        XmlNode xmlNfeNodeXR03_1vPIS = xmlNfeElement;
                                        xmlNfeNodeXR03_1.AppendChild(xmlNfeNodeXR03_1vPIS);
                                        xmlNfe.AppendChild(xmlNfeNode);
                                        //----------------------------------------------------------------- fim
                                    }
                                }
                            ...
                            if (regrasNfe.verificaCofinsInformado(Cofins))
                            {
                                ...
                                // ---------------------------------------------------------------- inicio vBC -- S07 - S02
                                xmlNfeElement = xmlNfe.CreateElement("vBC");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSAliq_vBC, 2, 1, 16, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSAliq_pCOFINS, 2, 1, 8, false, null);
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSAliq_vCOFINS, 2, 1, 16, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("qBCProd");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSQtde_qBCProd, 2, 1, 17, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("vAliqProd");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSQtde_vAliqProd, 2, 1, 16, false, null);
                                ...
                                xmlNfeElement = xmlNfe.CreateElement("vCOFINS");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSQtde_vCOFINS, 2, 1, 16, false, null);
                                ...
                                // ---------------------------------------------------------------- inicio vBC -- S07 - S06.1
                                xmlNfeElement = xmlNfe.CreateElement("vBC");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSOutr_vBC, 2, 1, 16, false, null);
                                XmlNode xmlNfeNodeXS06_1vBC = xmlNfeElement;
                                xmlNfeNodeXS06_1.AppendChild(xmlNfeNodeXS06_1vBC);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim

                                // ---------------------------------------------------------------- inicio pCOFINS -- S08 - S06.1
                                xmlNfeElement = xmlNfe.CreateElement("pCOFINS");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSOutr_pCOFINS, 2, 1, 8, false, null);
                                XmlNode xmlNfeNodeXS06_1pCOFINS = xmlNfeElement;
                                xmlNfeNodeXS06_1.AppendChild(xmlNfeNodeXS06_1pCOFINS);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim
                                ...
                                // ---------------------------------------------------------------- inicio qBCProd -- S09 - S08.1
                                xmlNfeElement = xmlNfe.CreateElement("qBCProd");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSOutr_qBCProd, 2, 1, 17, false, null);
                                XmlNode xmlNfeNodeXS08_1qBCProd = xmlNfeElement;
                                xmlNfeNodeXS08_1.AppendChild(xmlNfeNodeXS08_1qBCProd);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim

                                // ---------------------------------------------------------------- inicio vAliqProd -- S10 - S08.1
                                xmlNfeElement = xmlNfe.CreateElement("vAliqProd");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSOutr_vAliqProd, 2, 1, 16, false, null);
                                XmlNode xmlNfeNodeXS08_1vAliqProd = xmlNfeElement;
                                xmlNfeNodeXS08_1.AppendChild(xmlNfeNodeXS08_1vAliqProd);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim

                                // ---------------------------------------------------------------- inicio vCOFINS -- S11 - S08.1
                                xmlNfeElement = xmlNfe.CreateElement("vCOFINS");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(Cofins.COFINS_COFINSOutr_vCOFINS, 2, 1, 16, false, null);
                                XmlNode xmlNfeNodeXS08_1vCOFINS = xmlNfeElement;
                                xmlNfeNodeXS08_1.AppendChild(xmlNfeNodeXS08_1vCOFINS);
                                xmlNfe.AppendChild(xmlNfeNode);
                                //----------------------------------------------------------------- fim
                            }
                            #endregion
                            ...
                            if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                            {
                                ...
                                if (regrasNfe.verificaCofinsSt(CofinsST))
                                {
                                    ...
                                    // ---------------------------------------------------------------- inicio vBC -- T02 - T01.1
                                    xmlNfeElement = xmlNfe.CreateElement("vBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(CofinsST.COFINSST_vBC, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeXT01_1vBC = xmlNfeElement;
                                    xmlNfeNodeXT01_1.AppendChild(xmlNfeNodeXT01_1vBC);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio pCOFINS -- T03 - T01.1
                                    xmlNfeElement = xmlNfe.CreateElement("pCOFINS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(CofinsST.COFINSST_pCOFINS, 2, 1, 8, false, null);
                                    XmlNode xmlNfeNodeXT01_1pCOFINS = xmlNfeElement;
                                    xmlNfeNodeXT01_1.AppendChild(xmlNfeNodeXT01_1pCOFINS);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim
                                    ...
                                    // ---------------------------------------------------------------- inicio qBCProd -- T04 - T03.1
                                    xmlNfeElement = xmlNfe.CreateElement("qBCProd");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(CofinsST.COFINSST_qBCProd, 2, 1, 17, false, null);
                                    XmlNode xmlNfeNodeXT03_1qBCProd = xmlNfeElement;
                                    xmlNfeNodeXT03_1.AppendChild(xmlNfeNodeXT03_1qBCProd);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio vAliqProd -- T05 - T03.1
                                    xmlNfeElement = xmlNfe.CreateElement("vAliqProd");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(CofinsST.COFINSST_vAliqProd, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeXT03_1vAliqProd = xmlNfeElement;
                                    xmlNfeNodeXT03_1.AppendChild(xmlNfeNodeXT03_1vAliqProd);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim

                                    // ---------------------------------------------------------------- inicio vCOFINS -- T06 - T03.1
                                    xmlNfeElement = xmlNfe.CreateElement("vCOFINS");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(CofinsST.COFINSST_vCOFINS, 2, 1, 16, false, null);
                                    XmlNode xmlNfeNodeXT03_1vCOFINS = xmlNfeElement;
                                    xmlNfeNodeXT03_1.AppendChild(xmlNfeNodeXT03_1vCOFINS);
                                    xmlNfe.AppendChild(xmlNfeNode);
                                    //----------------------------------------------------------------- fim
                                }
                            }
                            ...
                            if (regrasNfe.verificaIssqn(ISSQN))
                            {
                                if (regrasNfe.verificaIssqnExclusivo(ICMSNormalST, ImpostoProdutosIndustrializados, ImpostoImportacao))
                                {
                                    ...
                                    // ---------------------------------------------------------------- inicio vBC -- U02 - U01
                                    xmlNfeElement = xmlNfe.CreateElement("vBC");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_vBC, 2, 1, 16, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_vAliq, 1, 1, 8, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_vISSQN, 1, 1, 16, false, null);
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("cMunFG");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_cMunFG, 1, 7, 7, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_cListServ, 1, 5, 5, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ISSQN.ISSQN_vDeducao))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_vDeducao, 1, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ISSQN.ISSQN_vDescIncond))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_vDescIncond, 1, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ISSQN.ISSQN_vDescCond))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_vDescCond, 1, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ISSQN.ISSQN_vISSRet))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_vISSRet, 1, 1, 16, false, null);
                                    ...
                                    if (regrasNfe.verificaCampoVazio(ISSQN.ISSQN_cServico))
                                    {
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_cServico, 1, 1, 20, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("cMun");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_cMun, 1, 7, 7, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("cPais");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(ISSQN.ISSQN_cPais, 1, 4, 4, false, null);
                            ...
                            if (regrasNfe.verificaTributosDevolvido(TributosDevolvidos))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TributosDevolvidos.impostoDevol_vIPIDevol, 1, 1, 16, false, null);
                            ...
                            if (regrasNfe.verificaCampoVazio(InformacoesAdicionais.ISSQN_infAdProd))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesAdicionais.ISSQN_infAdProd, 1, 1, 500, false, null);
                    ...
                    // ---------------------------------------------------------------- inicio vBC -- W03 - W02
                    xmlNfeElement = xmlNfe.CreateElement("vBC");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vBC, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vICMS");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vICMS, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vICMSDeson");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vICMSDeson, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vBCST");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vBCST, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vST, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vProd");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vProd, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vFrete");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vFrete, 1, 1, 16, false, null);
                    ...
                    // ---------------------------------------------------------------- inicio vSeg -- W09 - W02
                    xmlNfeElement = xmlNfe.CreateElement("vSeg");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vSeg, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vDesc");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vDesc, 1, 1, 16, false, null);
                    ...
                    // ---------------------------------------------------------------- inicio vII -- W11 - W02
                    xmlNfeElement = xmlNfe.CreateElement("vII");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vII, 1, 1, 16, false, null);
                    ...
                    // ---------------------------------------------------------------- inicio vIPI -- W12 - W02
                    xmlNfeElement = xmlNfe.CreateElement("vIPI");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vIPI, 1, 1, 16, false, null);
                    ...
                    // ---------------------------------------------------------------- inicio vPIS -- W13 - W02
                    xmlNfeElement = xmlNfe.CreateElement("vPIS");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vPIS, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vCOFINS");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vCOFINS, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vOutro");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vOutro, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vNF, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("vTotTrib");
                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFe.total_ICMSTot_vTotTrib, 1, 1, 16, false, null);
                    ...
                    if (regrasNfe.verificaGrupoTotaisReferenteIssqn(TotalNFeISSQN))
                    {
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeISSQN.total_ISSQNtot_vServ))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vServ, 1, 1, 16, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("vBC");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vBC, 1, 1, 16, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeISSQN.total_ISSQNtot_vISS))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vISS, 1, 1, 16, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("vPIS");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vPIS, 1, 1, 16, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("vCOFINS");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vCOFINS, 1, 1, 16, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeISSQN.total_ISSQNtot_dCompet))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_dCompet, 2, 8, 8, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("vDeducao");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vDeducao, 1, 1, 16, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("vOutro");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vOutro, 1, 1, 16, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("vDescIncond");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vDescIncond, 1, 1, 16, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("vDescCond");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vDescCond, 1, 1, 16, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("vISSRet");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_vISSRet, 1, 1, 16, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeISSQN.total_ISSQNtot_vISSRet))
                        {
                            if (regrasNfe.verificaCodigoRegimeEspecialTributacao(TotalNFeISSQN.total_ISSQNtot_cRegTrib))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeISSQN.total_ISSQNtot_cRegTrib, 2, 2, 2, true, null);
                    ...
                    if (regrasNfe.verificaTotalNfeRetencaoProduto(TotalNFeRetencaoTributos))
                    {
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeRetencaoTributos.total_retTrib_vRetPIS))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeRetencaoTributos.total_retTrib_vRetPIS, 1, 1, 16, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeRetencaoTributos.total_retTrib_vRetCOFINS))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeRetencaoTributos.total_retTrib_vRetCOFINS, 1, 1, 16, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeRetencaoTributos.total_retTrib_vRetCSLL))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeRetencaoTributos.total_retTrib_vRetCSLL, 1, 1, 16, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeRetencaoTributos.total_retTrib_vBCIRRF))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeRetencaoTributos.total_retTrib_vBCIRRF, 1, 1, 16, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeRetencaoTributos.total_retTrib_vIRRF))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeRetencaoTributos.total_retTrib_vIRRF, 1, 1, 2, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeRetencaoTributos.total_retTrib_vRetCSLL))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeRetencaoTributos.total_retTrib_vBCRetPrev, 1, 1, 16, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(TotalNFeRetencaoTributos.total_retTrib_vRetPrev))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(TotalNFeRetencaoTributos.total_retTrib_vRetPrev, 1, 1, 16, false, null);
                    ...
                    if (regrasNfe.verificaGrupoTransportador(InformacoesTransporteNFe.transp_transporta_CNPJ, InformacoesTransporteNFe.transp_transporta_CPF, InformacoesTransporteNFe.transp_transporta_xNome, InformacoesTransporteNFe.transp_transporta_IE, InformacoesTransporteNFe.transp_transporta_xEnder, InformacoesTransporteNFe.transp_transporta_xMun, InformacoesTransporteNFe.transp_transporta_UF))
                    {
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_transporta_CNPJ, 2, 14, 14, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("CPF");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_transporta_CPF, 2, 11, 11, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("xNome");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_transporta_xNome, 2, 2, 60, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("IE");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_transporta_IE, 2, 2, 14, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(InformacoesTransporteNFe.transp_transporta_xEnder))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_transporta_xEnder, 2, 1, 60, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("xMun");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_transporta_xMun, 2, 1, 60, false, null);
                        ...
                        {
                            xmlNfeElement = xmlNfe.CreateElement("UF");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_transporta_UF, 2, 2, 2, false, null);
                    ...
                    if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                    {
                            ...
                            InformacoesTransporteNFe.transp_retTransp_cMunFG))
                        {
                            ...
                            xmlNfeElement = xmlNfe.CreateElement("vServ");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_retTransp_vServ, 1, 1, 16, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_retTransp_vBCRet, 1, 1, 16, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_retTransp_pICMSRet, 2, 1, 8, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_retTransp_vICMSRet, 1, 1, 16, false, null);
                            ...
                            // ---------------------------------------------------------------- inicio CFOP  -- X16 - X11
                            xmlNfeElement = xmlNfe.CreateElement("CFOP");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_retTransp_CFOP, 2, 4, 4, false, null);
                            ...
                            xmlNfeElement = xmlNfe.CreateElement("cMunFG");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_retTransp_cMunFG, 2, 7, 7, false, null);
                        ...
                        if (regrasNfe.verificaGrupoVeiculoTransporte(InformacoesTransporteNFe.transp_veicTransp_placa, InformacoesTransporteNFe.transp_veicTransp_UF))
                        {
                            ...
                            // ---------------------------------------------------------------- inicio veicTransp -- X18 - X17.1
                            xmlNfeElement = xmlNfe.CreateElement("veicTransp");
                            XmlNode xmlNfeNodeXX17_1veicTransp = xmlNfeElement;
                            xmlNfeNodeXX17_1.AppendChild(xmlNfeNodeXX17_1veicTransp);
                            xmlNfe.AppendChild(xmlNfeNode);
                            //----------------------------------------------------------------- fim

                            // ---------------------------------------------------------------- inicio placa -- X19 - X18
                            xmlNfeElement = xmlNfe.CreateElement("placa");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_veicTransp_placa, 2, 7, 7, false, null);
                            ...
                            // ---------------------------------------------------------------- inicio UF -- X20 - X18
                            xmlNfeElement = xmlNfe.CreateElement("UF");
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_veicTransp_UF, 2, 2, 2, false, null);
                            ...
                            if (regrasNfe.verificaCampoVazio(InformacoesTransporteNFe.transp_veicTransp_RNTC))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_veicTransp_RNTC, 2, 1, 20, false, null);
                        ...
                        if (regrasNfe.verificaGrupoVeiculoTransporte(InformacoesTransporteNFe.transp_reboque_placa, InformacoesTransporteNFe.transp_reboque_UF))
                        {
                            for (int t = 0; t < listaInformacoesTransporteNFe.Count; t++)
                            {
                                ...
                                if (listaInformacoesTransporteNFe[t].numeroNotaFiscal.Equals(identificacaoNfe.ide_nNF))
                                {
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("placa");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_reboque_placa, 2, 7, 7, false, null);
                                    ...
                                    // ---------------------------------------------------------------- inicio UF -- X24 - X22
                                    xmlNfeElement = xmlNfe.CreateElement("UF");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_reboque_UF, 2, 2, 2, false, null);
                                    ...
                                    {
                                        xmlNfeElement = xmlNfe.CreateElement("RNTC");
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_reboque_RNTC, 2, 1, 20, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(InformacoesTransporteNFe.transp_reboque_vagao))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_reboque_vagao, 2, 1, 20, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(InformacoesTransporteNFe.transp_reboque_balsa))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_reboque_balsa, 2, 1, 20, false, null);
                        ...
                        for (int y = 0; y < listaInformacoesTransporteNFe.Count; y++)
                        {
                            ...
                            if (listaInformacoesTransporteNFe[y].numeroNotaFiscal.Equals(identificacaoNfe.ide_nNF))
                            {
                                ...
                                if (regrasNfe.verificaCampoVazio(InformacoesTransporteNFe.transp_vol_qVol))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_vol_qVol, 2, 1, 15, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(InformacoesTransporteNFe.transp_vol_esp))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_vol_esp, 2, 1, 60, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(InformacoesTransporteNFe.transp_vol_marca))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_vol_marca, 2, 1, 60, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(InformacoesTransporteNFe.transp_vol_nVol))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_vol_nVol, 2, 1, 60, false, null);
                                ...
                                {
                                    xmlNfeElement = xmlNfe.CreateElement("pesoL");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_vol_pesoL, 2, 1, 16, false, null);
                                ...
                                {
                                    xmlNfeElement = xmlNfe.CreateElement("pesoB");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_vol_pesoB, 2, 1, 16, false, null);
                    ...
                    if (regrasNfe.verificaGrupoLacre(InformacoesTransporteNFe.transp_vol_lacres_nLacre))
                    {
                        for (int u = 0; u < listaInformacoesTransporteNFe.Count; u++)
                        {
                            ...
                            if (listaInformacoesTransporteNFe[u].numeroNotaFiscal.Equals(identificacaoNfe.ide_nNF))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesTransporteNFe.transp_vol_lacres_nLacre, 2, 1, 60, false, null);
                        ...
                        if (regrasNfe.verificaGrupoCobrancaFatura(DadosCobranca.cobr_fat_nFat, DadosCobranca.cobr_fat_vOrig, DadosCobranca.cobr_fat_vDesc, DadosCobranca.cobr_fat_vLiq) || regrasNfe.verificaGrupoCobrancaDuplicata(DadosCobranca.cobr_dup_nDup, DadosCobranca.cobr_dup_dVenc, DadosCobranca.cobr_dup_vDup))
                        {
                            ...
                            if (regrasNfe.verificaGrupoCobrancaFatura(DadosCobranca.cobr_fat_nFat, DadosCobranca.cobr_fat_vOrig, DadosCobranca.cobr_fat_vDesc, DadosCobranca.cobr_fat_vLiq))
                            {
                                ...
                                if (regrasNfe.verificaCampoVazio(DadosCobranca.cobr_fat_nFat))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DadosCobranca.cobr_fat_nFat, 2, 1, 60, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(DadosCobranca.cobr_fat_vOrig))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DadosCobranca.cobr_fat_vOrig, 1, 1, 16, false, null);
                                ...
                                {
                                    xmlNfeElement = xmlNfe.CreateElement("vDesc");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DadosCobranca.cobr_fat_vDesc, 1, 1, 16, false, null);
                                ...
                                if (regrasNfe.verificaCampoVazio(DadosCobranca.cobr_fat_vLiq))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DadosCobranca.cobr_fat_vLiq, 1, 1, 16, false, null);
                                ...
                                for (int o = 0; o < listaDadosCobranca.Count; o++)
                                {
                                    ...
                                    if (listaDadosCobranca[o].numeroNotaFiscal.Equals(identificacaoNfe.ide_nNF))
                                    {
                                        ...
                                        if (regrasNfe.verificaCampoVazio(DadosCobranca.cobr_dup_nDup))
                                        {
                                            ...
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DadosCobranca.cobr_dup_nDup, 2, 1, 60, false, null);
                                        ...
                                        if (regrasNfe.verificaCampoVazio(DadosCobranca.cobr_dup_dVenc))
                                        {
                                            ...
                                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DadosCobranca.cobr_dup_dVenc, 3, null, null, false, null);
                                        ...
                                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(DadosCobranca.cobr_dup_vDup, 1, 1, 16, false, null);
                    ...
                    if (!regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                    {
                        for (int r = 0; r < listaFormasPagamento.Count; r++)
                        {
                            ...
                            if (listaFormasPagamento[r].numeroNotaFiscal.Equals(identificacaoNfe.ide_cNF))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(FormasPagamento.pag_vPag, 1, 1, 16, false, null);
                                ...
                                if (regrasNfe.verificaGrupoCartoes(FormasPagamento.pag_card_CNPJ, FormasPagamento.pag_card_tBand, FormasPagamento.pag_card_cAut))
                                {
                                    ...
                                    xmlNfeElement = xmlNfe.CreateElement("CNPJ");
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(FormasPagamento.pag_card_CNPJ, 2, 14, 14, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(FormasPagamento.pag_card_cAut, 2, 1, 20, false, null);
                        ...
                        regrasNfe.verificaGrupoProcessoReferenciado(InformacoesAdicionaisNFe.infAdic_procRef_nProc, InformacoesAdicionaisNFe.infAdic_procRef_indProc))
                    {
                        ...
                        if (regrasNfe.verificaGrupoInformacoesAdicionais(InformacoesAdicionaisNFe.infAdic_infAdFisco, InformacoesAdicionaisNFe.infAdic_infCpl))
                        {
                            ...
                            if (regrasNfe.verificaCampoVazio(InformacoesAdicionaisNFe.infAdic_infAdFisco))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesAdicionaisNFe.infAdic_infAdFisco, 2, 1, 2000, false, null);
                            ...
                            if (regrasNfe.verificaCampoVazio(InformacoesAdicionaisNFe.infAdic_infCpl))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesAdicionaisNFe.infAdic_infCpl, 2, 1, 5000, false, null);
                        ...
                        if (regrasNfe.verificaCampoLivreContribuinte(InformacoesAdicionaisNFe.infAdic_obsCont_xCampo, InformacoesAdicionaisNFe.infAdic_obsCont_xTexto))
                        {
                            for (int p = 0; p < listaInformacoesAdicionaisNFe.Count; p++)
                            {
                                ...
                                if (listaInformacoesAdicionaisNFe[p].numeroNotaFiscal.Equals(identificacaoNfe.ide_nNF))
                                {
                                    ...
                                    xmlNfeElement.SetAttribute(null, "xCampo", regrasNfe.validacaoPadraoCampos(InformacoesAdicionaisNFe.infAdic_obsCont_xCampo, 2, 1, 20, false, null)); //xCampo -- Z05 - Z04
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesAdicionaisNFe.infAdic_obsCont_xTexto, 2, 1, 60, false, null);
                        ...
                        if (regrasNfe.verificaGrupoProcessoReferenciado(InformacoesAdicionaisNFe.infAdic_procRef_nProc, InformacoesAdicionaisNFe.infAdic_procRef_indProc))
                        {
                            for (int s = 0; s < listaInformacoesAdicionaisNFe.Count; s++)
                            {
                                ...
                                if (listaInformacoesAdicionaisNFe[s].numeroNotaFiscal.Equals(identificacaoNfe.ide_nNF))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesAdicionaisNFe.infAdic_procRef_nProc, 2, 1, 60, false, null);
                    ...
                    if (regrasNfe.verificaInformacoesComercioExterior(InformacoesComercioExterior.exporta_UFSaidaPais, InformacoesComercioExterior.exporta_xLocExporta))
                    {
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesComercioExterior.exporta_UFSaidaPais, 2, 2, 2, false, null);
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesComercioExterior.exporta_xLocExporta, 2, 1, 60, false, null);
                        ...
                        if (regrasNfe.verificaCampoVazio(InformacoesComercioExterior.exporta_xLocDespacho))
                        {
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesComercioExterior.exporta_xLocDespacho, 2, 1, 60, false, null);
                    ...
                    if (regrasNfe.verificaTipoModelo55NFe(identificacaoNfe.ide_mod))
                    {
                        ...
                        if (regrasNfe.verificaInformacoesCompra(InformacoesCompras.compra_xNEmp, InformacoesCompras.compra_xPed, InformacoesCompras.compra_xCont))
                        {
                            ...
                            if (regrasNfe.verificaCampoVazio(InformacoesCompras.compra_xNEmp))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesCompras.compra_xNEmp, 2, 1, 22, false, null);
                            ...
                            {
                                xmlNfeElement = xmlNfe.CreateElement("xPed");
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesCompras.compra_xPed, 2, 1, 60, false, null);
                            ...
                            if (regrasNfe.verificaCampoVazio(InformacoesCompras.compra_xCont))
                            {
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesCompras.compra_xCont, 2, 1, 60, false, null);
                    ...
                    if (regrasNfe.verificaInformacoesRegistroAquisicaoCana(InformacoesRegistroAquisicaoCana.cana_safra, InformacoesRegistroAquisicaoCana.cana_ref))
                    {
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_safra, 2, 4, 9, false, null);
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_ref, 2, 1, 7, false, null);
                        ...
                        for (int d = 0; d < listaInformacoesRegistroAquisicaoCana.Count; d++)
                        {
                            ...
                            if (InformacoesRegistroAquisicaoCana.numeroNotaFiscal.Equals(identificacaoNfe.ide_nNF))
                            {
                                ...
                                xmlNfeElement.SetAttribute(null, "dia", regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_forDia_dia, 2, 1, 2, false, null)); //dia -- ZC05 - ZC04
                                ...
                                xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_forDia_qtde, 2, 1, 22, false, null);
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_forDia_qTotMes, 2, 1, 22, false, null);
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_forDia_qTotAnt, 2, 1, 22, false, null);
                        ...
                        xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_forDia_qTotGer, 2, 1, 22, false, null);
                            ...
                            xmlNfeElement.InnerText = InformacoesRegistroAquisicaoCana.cana_deduc_vTotDed, xmlNfeElement.InnerText = InformacoesRegistroAquisicaoCana.cana_deduc_vLiqFor))
                        {
                            for (int f = 0; f < listaInformacoesRegistroAquisicaoCana.Count; f++)
                            {
                                if (listaInformacoesRegistroAquisicaoCana[f].numeroNotaFiscal.Equals(identificacaoNfe.ide_nNF))
                                {
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_deduc_xDed, 2, 1, 60, false, null);
                                    ...
                                    xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_deduc_vDed, 1, 1, 16, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_deduc_vFor, 1, 1, 16, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_deduc_vTotDed, 1, 1, 16, false, null);
                            ...
                            xmlNfeElement.InnerText = regrasNfe.validacaoPadraoCampos(InformacoesRegistroAquisicaoCana.cana_deduc_vLiqFor, 1, 1, 16, false, null);
                    ...
                    xmlNfeElement = xmlNfe.CreateElement("Transforms");
                    ...
                    xmlTransformsNode.AppendChild(xmlTransformNode);
                    xmlNfe.AppendChild(xmlNfeNode);

                    xmlNfeElement = xmlNfe.CreateElement("Transform");
                    xmlNfeElement.SetAttribute("Algorithm", "http://www.w3.org/TR/2001/REC-xml-c14n-20010315");
                    xmlTransformNode = xmlNfeElement;
                    xmlTransformsNode.AppendChild(xmlTransformsNode);
                ...
                xmlNfe.Save(@"D:\Alexandre\Work\ERPRO\Documentos\Notas Fiscais\arquivo.xml");
            }
            catch (Exception ex)
            {
    ...
    public class regrasNegocioNfe
    {
                                    ...
                                    if (dadosChave.formaEmissao.Length == 1)
                                    {
                                        if (dadosChave.codigoNumero.Trim().Length == 8)
                                        {
                                            ...
                                            for (int i = 42; i >= 0; i--)
                                            {
                                                if (multiplicador == 10)
                                                    multiplicador = 2;
                                                somaTotal += Convert.ToInt32(codigoFinal[i]) * multiplicador;
                                                multiplicador++;
                                            }
                                        ...
                                        {
                                            MessageBox.Show("Erro ao gerar o código de acesso da NF-e. Código da NF-e Inválida.");
                                            return "";
                                        }
                                    }
                                    else
                                    {
                                        MessageBox.Show("Erro ao gerar o código de acesso da NF-e. Forma de emissão da NF-e Inválida.");
                                        return "";
                                    }
                                }
                                else
                                {
                                    MessageBox.Show("Erro ao gerar o código de acesso da NF-e. Número da NF-e Inválida.");
                                    return "";
                                }
                            }
                            else
                            {
                                MessageBox.Show("Erro ao gerar o código de acesso da NF-e. Série da NF-e Inválida.");
                                return "";
                            }
                        }
                        else
                        {
                            MessageBox.Show("Erro ao gerar o código de acesso da NF-e. Modelo da NF-e Inválida.");
                            return "";
                        }
                    }
                    else
                    {
                        MessageBox.Show("Erro ao gerar o código de acesso da NF-e. CNPJ inválido.");
                        return "";
                    }
                }
                else
                {
                    MessageBox.Show("Erro ao gerar o código de acesso da NF-e. Data inválida.");
                    return "";
                }
            }
            else
            {
                MessageBox.Show("Erro ao gerar o código de acesso da NF-e. Código de estado inválido.");
                return "";
            }
        }
        ...
        public string validacaoPadraoCampos(string texto, Int16 tpCampo, int? qtdMin, int? qtdMax, bool autocompletar, string caracterAutocompletar)
        {
            if (texto != null)
            {
                texto = texto.Trim();
                if (texto.Length > 0)
                {
                    ...
                    if (tpCampo > 0 && tpCampo < 6)
                    {
                        ...
                        else
                        {
                            ...
                            if (tpCampo == 2)
                            {
                                ...
                                {
                                    MessageBox.Show("Quantidade mínima de caracteres não alcançado, mínimo de " + qtdMin + " caracteres.");
                                }
                            }
                            else
                            {
                                ...
                                if (tpCampo == 3)
                                {
                                    ...
                                    {
                                        MessageBox.Show("Data no formato incorreto! Erro: " + e.Message);
                                        return "";
                                    }
                                }
                                else
                                {
                                    ...
                                    if (tpCampo == 4)
                                    {
                                        try
                                        {
                                            DateTime data = DateTime.ParseExact(texto.Replace("/", "-"), "dd-MM-yyyy HH:mm:ss", CultureInfo.InvariantCulture);
                                            texto = data.ToString("yyyy-MM-dd HH:mm:ss");
                                            return texto;
                                        }
                                        catch (Exception e)
                                        {
                                            MessageBox.Show("Data/hora no formato incorreto! Erro:" + e.Message);
                                            return "";
                                        }
                                    }
                                    else
                                    {
                                        ...
                                        if (tpCampo == 5)
                                        {
                                            ...
                                            {
                                                MessageBox.Show("Hora no formato incorreto! Erro:" + e.Message);
                                                return "";
                                            }
                                        }
                                    }
                    ...
                    {
                        MessageBox.Show("Tipo de campo inválido! Selecione 1 (numérico), 2 (alfanumérico), ou 3 (data).");
                    }
                }
                else
                {
                    string mensagem = "Quantidade de caracteres inválido, tamanho ideal: " + qtdMax + " caracteres. Atual: " + texto.Trim().Length;
        ...
        public bool verificaIndPag(string texto)
        {
            if (texto != null)
            {
                if (texto.Equals("0") || texto.Equals("1") || texto.Equals("2"))
                    ...
                    MessageBox.Show("Indicador de pagamento inválido");
            }
            return false;
        ...
        public bool verificaModeloNfe(string texto)
        {
            if (texto.Equals("55") || texto.Equals("65"))
                ...
                MessageBox.Show("Modelo da NFe inválido");
            return false;
        }
        ...
        public bool verificaSerie(string texto)
        {
            if ((Convert.ToInt32(texto) >= 0 && Convert.ToInt32(texto) <= 889) || (Convert.ToInt32(texto) >= 900 && Convert.ToInt32(texto) <= 999))
                ...
                MessageBox.Show("Série da NF inválida. Válido de 0 a 889 | 900 a 999.");
            return false;
        }
        ...
        public bool verificaTipoOperacao(string texto)
        {
            if (texto.Equals("0") || texto.Equals("1"))
                ...
                MessageBox.Show("Tipo de operação inválido. Permitido 0 - entrada | 1 - saída.");
            return false;
        }
        ...
        public bool verificaIdentificadorDestino(string texto)
        {
            if (texto.Equals("1") || texto.Equals("2") || texto.Equals("3"))
                ...
                MessageBox.Show("Identificador de destino inválido. Permitido 1 - Operação interna | 2 - Operação interestadual | 3 - Operação com exterior");
        ...
        public bool verificaMunicipioEstado(string codigoMunicipio, string codigoEstado)
        {
            ...
            {
                MessageBox.Show("código do município ou estado está incorreto.");
            }
            return false;
        }
        ...
        public bool verificaTipoImpressao(string texto)
        {
            try
            {
                ...
                if (valor >= 0 && valor <= 5)
                    ...
                    MessageBox.Show("Valor informado inválido. Informar valor de 0 a 5.");
            }
            catch (Exception erro)
            {
                MessageBox.Show("Valor informado inválido. Informar valor de 0 a 5. Erro: " + erro.Message);
            }
            return false;
        }
        ...
        public bool tipoAmbiente(string texto)
        {
            if (texto.Equals("1") || texto.Equals("2"))
                ...
                MessageBox.Show("Tipo de ambiente inválido.");
            return false;
        }
        ...
        public bool verifcaFinalidadeEmissao(string texto)
        {
            ...
            if (valor >= 1 && valor <= 4)
                ...
                MessageBox.Show("Finalidade informada inválida. Informar valor entre 1 e 4");
            return false;
        }
        ...
        public bool verificaCnpjEmissaoComplementar(string texto, string texto2)
        {
            if (texto.Equals(texto2))
                ...
                MessageBox.Show("CNPJ do emissor da nota complementar diferente da nota primária.");
            return false;
        }
        ...
        public bool verificaProcessoEmissao(string texto)
        {
            try
            {
                ...
                {
                    MessageBox.Show("Valor de processo de emissão inválido. Valores permitidos: 0 - Emissão de NF-e com aplicativo do contribuinte | 1 - Emissão de NF-e avulsa pelo Fisco | 2 - Emissão de NF-e avulsa, pelo contribuinte com seucertificado digital, através do site do Fisco | 3 - Emissão NF-e pelo contribuinte com aplicativo fornecido pelo Fisco.");
                }
            }
            catch (Exception erro)
            {
                MessageBox.Show("Valor de processo de emissão inválido. Valores permitidos: entre 0 e 3. Erro: " + erro);
            }
            return false;
        }
        ...
        public string validaSerie(string texto)
        {
            ...
            {
                MessageBox.Show("Valor inválido. Favor informar valor de 1 a 3.");
            }
            return texto;
        }
        ...
        {
            if (texto1.Trim().Length > 0 && texto1 != null && texto2.Trim().Length > 0 && texto2 != null)
                return true;
            return false;
        }
        ...
        {
            if (tipoNota.Equals("1") || tipoNota.Equals("") || tipoNota == null)
            {
                if (CNPJ.Trim().Length == 14 && (CPF.Trim().Length == 0 || CPF == null))
                    return "00000000000";
                else
                    MessageBox.Show("Valores de CNPJ e/ou CPF inválidos.");
                return CPF;
            }
            else
            {
        ...
        public bool verificaModeloProdutoRural(string texto)
        {
            if (texto.Equals("01") || texto.Equals("04"))
                ...
                MessageBox.Show("Modelo de nota inválido no momento. Permitidos 01 e 04.");
            return false;
        }
        ...
        public bool verificaModeloDocumentoFiscalReferenciado(string texto)
        {
            if (texto.Equals("2B") || texto.Equals("2C") || texto.Equals("2D"))
                ...
                MessageBox.Show("Modelo do documento fiscal referenciado inválido. Permitido 2B, 2C ou 2D");
            return false;
        }
        ...
        {
            if (IM.Trim().Length > 0 && CRT.Trim().Length > 0)
                return true;
            return false;
        }
        ...
        /// <returns>True ou false</returns>
        public bool verificaNomeDestinarario(string nome, string tipoNota)
        {
        ...
        /// <returns></returns>
        public bool verrificaPreenchimentoIdentificacaoDestinatarioNFe(string CNPJ, string CPF, string idEstrnageiro)
        {
            if (CNPJ != null || CPF != null || idEstrnageiro != null)
                if (CNPJ.Length > 0 || CPF.Length > 0 || idEstrnageiro.Length > 0)
                    return true;
            return false;
        }
        ...
        {
            if (dataContigencia != null && justificativa != null)
                if (dataContigencia.Length > 0 && justificativa.Length > 0)
                    return true;
            return false;
        }
        ...
        {
            if (numeroRegistro.Length > 0 && chaveAcesso.Length > 0 && quantidadeExportado.Length > 0)
                return true;
            return false;
        }
        ...
        /// <returns>True ou false</returns>
        public bool verificaPreenchimentoVeiculosNovos(dadosDetalhamentoEspecificoVeiculosNovos dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <returns>True ou false</returns>
        public bool verificaDetalhamentoEspecificoMedicamento(dadosDetalhamentoEspecificoMedicamentoMateriasPrimasFarmaceuticas dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para a verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaDetalhamentoEspecificoArmamentos(dadosDetalhamentoEspecificoArmamentos dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para a verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaDetalhamentoEspecificoCombustiveis(dadosDetalhamentoEspecificoCombustiveis dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para a verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaDetalhamentoEspecificoOperacaoPapelImune(dadosDetalhamentoEspecificoOperacaoPapelImune dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        {
            if (baseCalculo.Length > 0 && icmsSt.Length > 0)
                return true;
            return false;
        }
        ...
        /// <param name="dados">Valor para verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaPisSt(dadosPisST dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaCofinsInformado(dadosCofins dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaCofinsSt(dadosCofinsST dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaIssqn(dadosISSQN dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaTributosDevolvido(dadosTributosDevolvidos dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaGrupoTotaisReferenteIssqn(dadosTotalNFeISSQN dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        /// <param name="dados">Valor para verificação.</param>
        /// <returns>True ou false</returns>
        public bool verificaTotalNfeRetencaoProduto(dadosTotalNFeRetencaoTributos dados)
        {
            if (dados != null)
                return true;
            return false;
        ...
        {
            if (cnpj.Length > 0 || cpf.Length > 0 || nome.Length > 0 || ie.Length > 0 || endereco.Length > 0 || municipio.Length > 0 || estado.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (valorSevico.Length > 0 || baseCalculo.Length > 0 || aliquota.Length > 0 || valorIcms.Length > 0 || cfop.Length > 0 || codigoMunicipio.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (quantidadeVolume.Length > 0 || especieVolume.Length > 0 || marca.Length > 0 || numeroVolume.Length > 0 || pesoLiquido.Length > 0 || pesoBruto.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (numeroFatura.Length > 0 || valorOriginalFatura.Length > 0 || valorDesconto.Length > 0 || valorLiquido.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (numeroDuplicata.Length > 0 || dataVencimento.Length > 0 || valorDuplicata.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (cnpj.Length > 0 || bandeira.Length > 0 || codigoAutorizacao.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (informacoesAdicionais.Length > 0 || informacoesComplementares.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (identificadoProcesso.Length > 0 || indicadorOrigem.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (localEmbarque.Length > 0 || uf.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (notaEmpenho.Length > 0 || pedido.Length > 0 || contrato.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (safra.Length > 0 || referencia.Length > 0)
                return true;
            return false;
        }
        ...
        {
            if (descricaoDeducao.Length > 0 || valorDeducao.Length > 0 || valorFornecimento.Length > 0 || valorTotal.Length > 0 || valorLiquido.Length > 0)
                return true;
            return false;
        }
        ...
        /// <returns>True ou false</returns>
        public bool verificaMensagemRetornoRecepcao(XmlDocument retornoXml)
        {
            string codigoMensagem = retornoXml.GetElementById("cStat").Value;
            switch (codigoMensagem)
            {
                //solicitações atendidas
                case "100": mensagemAlerta("Autorizado o uso da NF-e");
                    return true;
                case "101": mensagemAlerta("Cancelamento de NF-e homologado");
                    return true;
                case "102": mensagemAlerta("Inutilização de número homologado");
                    return true;
                case "103": mensagemAlerta("Lote recebido com sucesso");
                    return true;
                case "104": mensagemAlerta("Lote processado");
                    return true;
                case "105": mensagemAlerta("Lote em processamento");
                    return true;
                case "106": mensagemAlerta("Lote não localizado");
                    return true;
                case "107": mensagemAlerta("Serviço em Operação");
                    return true;
                case "108": mensagemAlerta("Serviço Paralisado Momentaneamente (curto prazo)");
                    return true;
                case "109": mensagemAlerta("Serviço Paralisado sem Previsão");
                    return true;
                case "110": mensagemAlerta("Uso Denegado");
                    return true;
                case "111": mensagemAlerta("Consulta cadastro com uma ocorrência"); 
                    return true;
                case "112": mensagemAlerta("Consulta cadastro com mais de uma ocorrência");
                    return true;
                case "128": mensagemAlerta("Lote de Evento Processado");
                    return true;
                case "135": mensagemAlerta("Evento registrado e vinculado a NF-e");
                    return true;
                case "136": mensagemAlerta("Evento registrado, mas não vinculado a NF-e");
                    return true;
                //solicitações não atendidas
                case "201": mensagemAlerta("Rejeição: O numero máximo de numeração de NF-e a inutilizar ultrapassou o limite");
                    break;
                case "202": mensagemAlerta("Rejeição: Falha no reconhecimento da autoria ou integridade do arquivo digital");
                    break;
                case "203": mensagemAlerta("Rejeição: Emissor não habilitado para emissão da NF-e");
                    break;
                case "204": mensagemAlerta("Duplicidade de NF-e");
                    break;
                case "205": mensagemAlerta("NF-e está denegada na base de dados da SEFAZ");
                    break;
                case "206": mensagemAlerta("Rejeição: NF-e já está inutilizada na Base de dados da SEFAZ");
                    break;
                case "207": mensagemAlerta("Rejeição: CNPJ do emitente inválido");
                    break;
                case "208": mensagemAlerta("Rejeição: CNPJ do destinatário inválido");
                    break;
                case "209": mensagemAlerta("Rejeição: IE do emitente inválida");
                    break;
                case "210": mensagemAlerta("Rejeição: IE do destinatário inválida");
                    break;
                case "211": mensagemAlerta("Rejeição: IE do substituto inválida");
                    break;
                case "212": mensagemAlerta("Rejeição: Data de emissão NF-e posterior a data de recebimento");
                    break;
                case "213": mensagemAlerta("Rejeição: CNPJ-Base do Emitente difere do CNPJ-Base do Certificado Digital");
                    break;
                case "214": mensagemAlerta("Rejeição: Tamanho da mensagem excedeu o limite estabelecido");
                    break;
                case "215": mensagemAlerta("Rejeição: Falha no schema XML");
                    break;
                case "216": mensagemAlerta("Rejeição: Chave de Acesso difere da cadastrada");
                    break;
                case "217": mensagemAlerta("Rejeição: NF-e não consta na base de dados da SEFAZ");
                    break;
                case "218": mensagemAlerta("NF-e já está cancelada na base de dados da SEFAZ");
                    break;
                case "219": mensagemAlerta("Rejeição: Circulação da NF-e verificada");
                    break;
                case "220": mensagemAlerta("Rejeição: Prazo de Cancelamento superior ao previsto na Legislação");
                    break;
                case "221": mensagemAlerta("Rejeição: Confirmado o recebimento da NF-e pelo destinatário");
                    break;
                case "222": mensagemAlerta("Rejeição: Protocolo de Autorização de Uso difere do cadastrado");
                    break;
                case "223": mensagemAlerta("Rejeição: CNPJ do transmissor do lote difere do CNPJ do transmissor da consulta");
                    break;
                case "224": mensagemAlerta("Rejeição: A faixa inicial é maior que a faixa final");
                    break;
                case "225": mensagemAlerta("Rejeição: Falha no Schema XML do lote de NFe");
                    break;
                case "226": mensagemAlerta("Rejeição: Código da UF do Emitente diverge da UF autorizadora");
                    break;
                case "227": mensagemAlerta("Rejeição: Erro na Chave de Acesso -Campo Id –falta a literal NFe");
                    break;
                case "228": mensagemAlerta("Rejeição: Data de Emissão muito atrasada");
                    break;
                case "229": mensagemAlerta("Rejeição: IE do emitente não informada");
                    break;
                case "230": mensagemAlerta("Rejeição: IE do emitente não cadastrada");
                    break;
                case "231": mensagemAlerta("Rejeição: IE do emitente não vinculada ao CNPJ");
                    break;
                case "232": mensagemAlerta("Rejeição: IE do destinatário não informada");
                    break;
                case "233": mensagemAlerta("Rejeição: IE do destinatário não cadastrada");
                    break;
                case "234": mensagemAlerta("Rejeição: IE do destinatário não vinculada ao CNPJ");
                    break;
                case "235": mensagemAlerta("Rejeição: Inscrição SUFRAMA inválida");
                    break;
                case "236": mensagemAlerta("Rejeição: Chave de Acesso com dígito verificador inválido");
                    break;
                case "237": mensagemAlerta("Rejeição: CPF do destinatário inválido");
                    break;
                case "238": mensagemAlerta("Rejeição: Cabeçalho -Versão do arquivo XML superior a Versão vigente");
                    break;
                case "239": mensagemAlerta("Rejeição: Cabeçalho -Versão do arquivo XML não suportada");
                    break;
                case "240": mensagemAlerta("Rejeição: Cancelamento/Inutilização -Irregularidade Fiscal do Emitente");
                    break;
                case "241": mensagemAlerta("Rejeição: Um número da faixa já foi utilizado");
                    break;
                case "242": mensagemAlerta("Rejeição: Cabeçalho -Falha no Schema XML");
                    break;
                case "243": mensagemAlerta("Rejeição: XML Mal Formado");
                    break;
                case "244": mensagemAlerta("Rejeição: CNPJ do Certificado Digital difere do CNPJ da Matriz edo CNPJ do Emitente");
                    break;
                case "245": mensagemAlerta("Rejeição: CNPJ Emitente não cadastrado");
                    break;
                case "246": mensagemAlerta("Rejeição: CNPJ Destinatário não cadastrado");
                    break;
                case "247": mensagemAlerta("Rejeição: Sigla da UF do Emitente diverge da UF autorizadora");
                    break;
                case "248": mensagemAlerta("Rejeição: UF do Recibo diverge da UF autorizadora");
                    break;
                case "249": mensagemAlerta("Rejeição: UF da Chave de Acesso diverge da UF autorizadora");
                    break;
                case "250": mensagemAlerta("Rejeição: UF diverge da UF autorizadora");
                    break;
                case "251": mensagemAlerta("Rejeição: UF/Município destinatário não pertence a SUFRAMA");
                    break;
                case "252": mensagemAlerta("Rejeição: Ambiente informado diverge do Ambiente de recebimento");
                    break;
                case "253": mensagemAlerta("Rejeição: Digito Verificador da chave de acesso composta inválida");
                    break;
                case "254": mensagemAlerta("Rejeição: NF-e complementar não possui NF referenciada");
                    break;
                case "255": mensagemAlerta("Rejeição: NF-e complementar possui mais de uma NF referenciada");
                    break;
                case "256": mensagemAlerta("Rejeição: Uma NF-e da faixa já está inutilizada na Base de dados da SEFAZ");
                    break;
                case "257": mensagemAlerta("Rejeição:Solicitante não habilitado para emissão da NF-e");
                    break;
                case "258": mensagemAlerta("Rejeição: CNPJ da consulta inválido");
                    break;
                case "259": mensagemAlerta("Rejeição: CNPJ da consulta não cadastrado como contribuinte na UF");
                    break;
                case "260": mensagemAlerta("Rejeição: IE da consulta inválida");
                    break;
                case "261": mensagemAlerta("Rejeição: IE da consulta não cadastrada como contribuinte na UF");
                    break;
                case "262": mensagemAlerta("Rejeição: UF não fornece consulta por CPF");
                    break;
                case "263": mensagemAlerta("Rejeição: CPF da consulta inválido");
                    break;
                case "264": mensagemAlerta("Rejeição: CPF da consulta não cadastrado como contribuinte na UF");
                    break;
                case "265": mensagemAlerta("Rejeição: Sigla da UF da consulta difere da UF do Web Service");
                    break;
                case "266": mensagemAlerta("Rejeição: Série utilizada não permitida no Web Service");
                    break;
                case "267": mensagemAlerta("Rejeição: NF Complementar referencia uma NF-e inexistente");
                    break;
                case "268": mensagemAlerta("Rejeição: NF Complementar referencia uma outra NF-e Complementar");
                    break;
                case "269": mensagemAlerta("Rejeição: CNPJ Emitente da NF Complementar difere do CNPJ da NF Referenciada");
                    break;
                case "270": mensagemAlerta("Rejeição: Código Município do Fato Gerador: dígito inválido");
                    break;
                case "271": mensagemAlerta("Rejeição: Código Município do Fato Gerador: difere da UF do emitente");
                    break;
                case "272": mensagemAlerta("Rejeição: Código Município do Emitente: dígito inválido");
                    break;
                case "273": mensagemAlerta("Rejeição: Código Município do Emitente: difere da UF do emitente");
                    break;
                case "274": mensagemAlerta("Rejeição: Código Município do Destinatário: dígito inválido");
                    break;
                case "275": mensagemAlerta("Rejeição: Código Município do Destinatário: difere da UF do Destinatário");
                    break;
                case "276": mensagemAlerta("Rejeição: Código Município do Local de Retirada: dígito inválido");
                    break;
                case "277": mensagemAlerta("Rejeição: Código Município do Local de Retirada: difere da UF do Local de Retirada");
                    break;
                case "278": mensagemAlerta("Rejeição: Código Município do Local de Entrega: dígito inválido");
                    break;
                case "279": mensagemAlerta("Rejeição: Código Município do Local de Entrega:difere da UF do Local de Entrega");
                    break;
                case "280": mensagemAlerta("Rejeição: Certificado Transmissor inválido");
                    break;
                case "281": mensagemAlerta("Rejeição: Certificado Transmissor Data Validade");
                    break;
                case "282": mensagemAlerta("Rejeição: Certificado Transmissor sem CNPJ");
                    break;
                case "283": mensagemAlerta("Rejeição: Certificado Transmissor -erro Cadeia de Certificação");
                    break;
                case "284": mensagemAlerta("Rejeição: Certificado Transmissor revogado");
                    break;
                case "285": mensagemAlerta("Rejeição: Certificado Transmissor difere ICP-Brasil");
                    break;
                case "286": mensagemAlerta("Rejeição: Certificado Transmissor erro no acesso a LCR");
                    break;
                case "287": mensagemAlerta("Rejeição: Código Município do FG -ISSQN: dígito inválido");
                    break;
                case "288": mensagemAlerta("Rejeição: Código Município do FG -Transporte: dígito inválido");
                    break;
                case "289": mensagemAlerta("Rejeição: Código da UF informadadiverge da UF solicitado");
                    break;
                case "290": mensagemAlerta("Rejeição: Certificado Assinatura inválido");
                    break;
                case "291": mensagemAlerta("Rejeição: Certificado Assinatura Data Validade");
                    break;
                case "292": mensagemAlerta("Rejeição: Certificado Assinatura sem CNPJ");
                    break;
                case "293": mensagemAlerta("Rejeição: Certificado Assinatura -erro Cadeia de Certificação");
                    break;
                case "294": mensagemAlerta("Rejeição: Certificado Assinatura revogado");
                    break;
                case "295": mensagemAlerta("Rejeição: Certificado Assinatura difere ICP-Brasil");
                    break;
                case "296": mensagemAlerta("Rejeição: Certificado Assinatura erro no acesso a LCR");
                    break;
                case "297": mensagemAlerta("Rejeição: Assinatura difere do calculado");
                    break;
                case "298": mensagemAlerta("Rejeição: Assinatura difere do padrão do Sistema");
                    break;
                case "299": mensagemAlerta("Rejeição: XML da área de cabeçalho com codificação diferente de UTF-8");
                    break;
                case "401": mensagemAlerta("Rejeição: CPF do remetente inválido");
                    break;
                case "402": mensagemAlerta("Rejeição: XML da área de dados com codificação diferente de UTF-8");
                    break;
                case "403": mensagemAlerta("Rejeição: O grupo de informações da NF-e avulsa é de uso exclusivo do Fisco");
                    break;
                case "404": mensagemAlerta("Rejeição: Uso de prefixo de namespace não permitido");
                    break;
                case "405": mensagemAlerta("Rejeição: Código do país do emitente: dígito inválido");
                    break;
                case "406": mensagemAlerta("Rejeição: Código do país do destinatário: dígito inválido");
                    break;
                case "407": mensagemAlerta("Rejeição: O CPF só pode ser informado no campo emitente para a NF-e avulsa");
                    break;
                case "409": mensagemAlerta("Rejeição: Campo cUF inexistente no elemento nfeCabecMsg do SOAP Header");
                    break;
                case "410": mensagemAlerta("Rejeição: UF informada no campo cUF não é atendida pelo Web Service");
                    break;
                case "411": mensagemAlerta("Rejeição: Campo versaoDados inexistente no elemento nfeCabecMsg do SOAP Header");
                    break;
                case "420": mensagemAlerta("Rejeição: Cancelamento para NF-e já cancelada");
                    break;
                case "450": mensagemAlerta("Rejeição: Modelo da NF-e diferente de 55");
                    break;
                case "451": mensagemAlerta("Rejeição: Processo de emissão informado inválido");
                    break;
                case "452": mensagemAlerta("Rejeição: Tipo Autorizador do Recibo diverge do Órgão Autorizado");
                    break;
                case "453": mensagemAlerta("Rejeição: Ano de inutilização não pode ser superior ao Ano atual");
                    break;
                case "454": mensagemAlerta("Rejeição: Ano de inutilização não pode ser inferior a 2006");
                    break;
                case "478": mensagemAlerta("Rejeição: Local da entrega não informado para faturamento direto de veículos novos");
                    break;
                case "489": mensagemAlerta("Rejeição: CNPJ informado inválido (DV ou zeros)");
                    break;
                case "490": mensagemAlerta("Rejeição: CPF informado inválido (DV ou zeros)");
                    break;
                case "491": mensagemAlerta("Rejeição: O tpEvento informado inválido");
                    break;
                case "492": mensagemAlerta("Rejeição: O verEvento informado inválido");
                    break;
                case "493": mensagemAlerta("Rejeição: Evento não atende o Schema XML específico");
                    break;
                case "494": mensagemAlerta("Rejeição: Chave de Acessoinexistente");
                    break;
                case "502": mensagemAlerta("Rejeição: Erro na Chave de Acesso -CampoId não corresponde à concatenação dos campos correspondentes");
                    break;
                case "503": mensagemAlerta("Rejeição: Série utilizada fora da faixa permitida no SCAN (900-999)");
                    break;
                case "504": mensagemAlerta("Rejeição: Data de Entrada/Saída posterior ao permitido");
                    break;
                case "505": mensagemAlerta("Rejeição: Data de Entrada/Saída anterior ao permitido");
                    break;
                case "506": mensagemAlerta("Rejeição: Data de Saída menor que a Data de Emissão");
                    break;
                case "507": mensagemAlerta("Rejeição: O CNPJ do destinatário/remetente não deve ser informado em operação com o exterior");
                    break;
                case "508": mensagemAlerta("Rejeição: O CNPJ com conteúdo nulo só é válido em operação com exterior");
                    break;
                case "509": mensagemAlerta("Rejeição: Informado código de município diferente de “9999999” para operação com o exterior");
                    break;
                case "510": mensagemAlerta("Rejeição: Operação com Exterior e Código País destinatário é 1058 (Brasil) ou não informado");
                    break;
                case "511": mensagemAlerta("Rejeição: Não é de Operação com Exterior e Código País destinatário difere de 1058(Brasil)");
                    break;
                case "512": mensagemAlerta("Rejeição: CNPJ do Local de Retirada inválido");
                    break;
                case "513": mensagemAlerta("Rejeição:  Código  Município  do  Local  de  Retirada  deve  ser  9999999  para  UF  retirada  = EX");
                    break;
                case "514": mensagemAlerta("Rejeição: CNPJ do Local de Entrega inválido");
                    break;
                case "515": mensagemAlerta("Rejeição: Código Município do Local de Entrega deve ser 9999999 para UF entrega = EX");
                    break;
                case "516": mensagemAlerta("Rejeição: Falha no schema XML–inexiste a tag raiz esperada para a mensagem");
                    break;
                case "517": mensagemAlerta("Rejeição: Falha no schema XML–inexiste atributo versao na tag raiz da mensagem");
                    break;
                case "518": mensagemAlerta("Rejeição: CFOP de entrada para NF-e de saída");
                    break;
                case "519": mensagemAlerta("Rejeição: CFOP de saída para NF-e de entrada");
                    break;
                case "520": mensagemAlerta("Rejeição: CFOP de Operação com Exterior e UF destinatário difere de EX");
                    break;
                case "521": mensagemAlerta("Rejeição:  CFOP  de  Operação  Estadual  e  UF  do  emitente  difere  da  UF  do  destinatário para destinatário contribuinte do ICMS.");
                    break;
                case "522": mensagemAlerta("Rejeição: CFOP de Operação Estadual e UF emitente difere da UF remetente para remetente contribuinte do ICMS.");
                    break;
                case "523": mensagemAlerta("Rejeição: CFOP não é de Operação Estadual e UF emitente igual a UFdestinatário.");
                    break;
                case "524": mensagemAlerta("Rejeição: CFOP de Operação com Exterior e não informado NCM");
                    break;
                case "525": mensagemAlerta("Rejeição: CFOP de Importação e não informado dados da DI");
                    break;
                case "526": mensagemAlerta("Rejeição: CFOP de Exportação e não informado Local de Embarque");
                    break;
                case "527": mensagemAlerta("Rejeição: Operação de Exportação com informação de ICMS incompatível");
                    break;
                case "528": mensagemAlerta("Rejeição: Valor do ICMS difere do produto BCe Alíquota");
                    break;
                case "529": mensagemAlerta("Rejeição: NCM de informação obrigatória para produto tributado pelo IPI");
                    break;
                case "530": mensagemAlerta("Rejeição: Operação com tributação de ISSQN sem informar a Inscrição Municipal");
                    break;
                case "531": mensagemAlerta("Rejeição: Total da BC ICMS difere do somatório dos itens");
                    break;
                case "532": mensagemAlerta("Rejeição: Total do ICMS difere do somatório dos itens");
                    break;
                case "533": mensagemAlerta("Rejeição: Total da BC ICMS-ST difere do somatório dos itens");
                    break;
                case "534": mensagemAlerta("Rejeição: Total do ICMS-ST difere do somatório dos itens");
                    break;
                case "535": mensagemAlerta("Rejeição: Total do Frete difere do somatório dos itens");
                    break;
                case "536": mensagemAlerta("Rejeição: Total do Seguro difere do somatório dos itens");
                    break;
                case "537": mensagemAlerta("Rejeição: Total do Desconto difere do somatório dos itens");
                    break;
                case "538": mensagemAlerta("Rejeição: Total do IPI difere do somatório dos itens");
                    break;
                case "539": mensagemAlerta("Duplicidade de NF-e com diferença na Chave de Acesso");
                    break;
                case "540": mensagemAlerta("Rejeição: CPF do Local de Retirada inválido");
                    break;
                case "541": mensagemAlerta("Rejeição: CPF do Local de Entrega inválido");
                    break;
                case "542": mensagemAlerta("Rejeição: CNPJ do Transportador inválido");
                    break;
                case "543": mensagemAlerta("Rejeição: CPF do Transportador inválido");
                    break;
                case "544": mensagemAlerta("Rejeição: IE do Transportador inválida");
                    break;
                case "545": mensagemAlerta("Rejeição: Falha no schema XML–versão informada na versaoDados do SOAPHeader diverge da versão da mensagem");
                    break;
                case "546": mensagemAlerta("Rejeição: Erro na Chave de Acesso –Campo Id –falta a literal NFe");
                    break;
                case "547": mensagemAlerta("Rejeição: Dígito Verificador da Chave de Acesso da NF-e Referenciada inválido");
                    break;
                case "548": mensagemAlerta("Rejeição: CNPJ da NF referenciada inválido.");
                    break;
                case "549": mensagemAlerta("Rejeição: CNPJ da NF referenciada de produtor inválido.");
                    break;
                case "550": mensagemAlerta("Rejeição: CPF da NF referenciada de produtor inválido.");
                    break;
                case "551": mensagemAlerta("Rejeição: IE da NF referenciada de produtor inválido");
                    break;
                case "552": mensagemAlerta("Rejeição: Dígito Verificador da Chave de Acesso do CT-e Referenciado inválido");
                    break;
                case "553": mensagemAlerta("Rejeição: Tipo autorizador do recibo diverge do Órgão Autorizador.");
                    break;
                case "554": mensagemAlerta("Rejeição: Série difere da faixa 0-899");
                    break;
                case "555": mensagemAlerta("Rejeição: Tipo autorizador do protocolo diverge do Órgão Autorizador.");
                    break;
                case "556": mensagemAlerta("Rejeição:  Justificativa  de  entrada  em  contingência  não  deve  ser  informada  para  tipo  de emissão normal.");
                    break;
                case "557": mensagemAlerta("Rejeição: A Justificativa de entrada em contingência deve ser informada.");
                    break;
                case "558": mensagemAlerta("Rejeição: Data de entrada em contingência posterior a datade recebimento.");
                    break;
                case "559": mensagemAlerta("Rejeição: UF do Transportador não informada");
                    break;
                case "560": mensagemAlerta("Rejeição: CNPJ base do emitente difere do CNPJ base da primeira NF-e do lote recebido");
                    break;
                case "561": mensagemAlerta("Rejeição: Mês de Emissão informado na Chave de Acesso difere do Mês de Emissão da NF-e");
                    break;
                case "562": mensagemAlerta("Rejeição:  Código  Numérico  informado  na  Chave  de  Acesso  difere  do  Código  Numérico da NF-e");
                    break;
                case "563": mensagemAlerta("Rejeição: Já existe pedido de Inutilização com a mesma faixa de inutilização");
                    break;
                case "564": mensagemAlerta("Rejeição: Total do Produto / Serviço difere do somatório dos itens");
                    break;
                case "565": mensagemAlerta("Rejeição: Falha no schema XML–inexiste a tag raiz esperada para o lote de NF-e");
                    break;
                case "567": mensagemAlerta("Rejeição: Falha no schema XML–versão informada na versaoDados do SOAPHeader diverge da versão do lote de NF-e");
                    break;
                case "568": mensagemAlerta("Rejeição:Falha no schema XML–inexiste atributo versao na tag raiz do lote de NF-e");
                    break;
                case "569": mensagemAlerta("Rejeição: Data de entrada em contingência muito atrasada");
                    break;
                case "570": mensagemAlerta("Rejeição: tpEmis = 3 só é válido na contingência SCAN");
                    break;
                case "571": mensagemAlerta("Rejeição: O tpEmis informado diferente de 3 para contingência SCAN");
                    break;
                case "572": mensagemAlerta("Rejeição: Erro Atributo ID do evento não corresponde a concatenação dos campos (“ID”+ tpEvento + chNFe + nSeqEvento)");
                    break;
                case "573": mensagemAlerta("Rejeição: Duplicidade de Evento");
                    break;
                case "574": mensagemAlerta("Rejeição: O autor do evento diverge do emissor da NF-e");
                    break;
                case "575": mensagemAlerta("Rejeição: O autor do evento diverge do destinatário da NF-e");
                    break;
                case "576": mensagemAlerta("Rejeição: O autor do evento não é um órgão autorizado a gerar o evento");
                    break;
                case "577": mensagemAlerta("Rejeição: A data do evento não pode ser menor que a data de emissão da NF-e");
                    break;
                case "578": mensagemAlerta("Rejeição: A data do evento não pode ser maior que a data do processamento");
                    break;
                case "579": mensagemAlerta("Rejeição: A data do evento não pode ser menor que a data de autorização para NF-e não emitida em contingência");
                    break;
                case "580": mensagemAlerta("Rejeição: O evento exige uma NF-e autorizada");
                    break;
                case "587": mensagemAlerta("Rejeição: Usar somente o namespace padrão da NF-e");
                    break;
                case "588": mensagemAlerta("Rejeição:Não é permitida a presença de caracteres de edição no início/fim da mensagem ou entre as tags da mensagem");
                    break;
                case "590": mensagemAlerta("Rejeição: Informado CST para emissor do Simples Nacional (CRT=1)");
                    break;
                case "591": mensagemAlerta("Rejeição: Informado CSOSN para emissor que não é do Simples Nacional (CRT diferente de 1)");
                    break;
                case "592": mensagemAlerta("Rejeição: A NF-e deve ter pelo menos um item de produto sujeito ao ICMS");
                    break;
                case "594": mensagemAlerta("Rejeição: O número de sequencia do evento informado é maior que o permitido");
                    break;
                case "595": mensagemAlerta("Rejeição: A versão do leiaute da NF-e utilizada não é mais válida");
                    break;
                case "596": mensagemAlerta("Rejeição: Ambiente de homologação indisponível para recepção de NF-e da versão 1.10.");
                    break;
                case "597": mensagemAlerta("Rejeição: CFOP de Importação e não informado dados de IPI");
                    break;
                case "598": mensagemAlerta("Rejeição: NF-e emitida em ambiente de homologação com Razão Social do destinatário diferente de NF-E EMITIDA EM AMBIENTE DE HOMOLOGACAO -SEM VALOR FISCAL");
                    break;
                case "599": mensagemAlerta("Rejeição: CFOP de Importação e não informado dados de II");
                    break;
                case "601": mensagemAlerta("Rejeição: Total do II difere do somatório dos itens");
                    break;
                case "602": mensagemAlerta("Rejeição: Total do PIS difere do somatório dos itens sujeitos ao ICMS");
                    break;
                case "603": mensagemAlerta("Rejeição: Total do COFINS difere do somatório dos itens sujeitos ao ICMS");
                    break;
                case "604": mensagemAlerta("Rejeição: Total do vOutro difere do somatório dos itens");
                    break;
                case "605": mensagemAlerta("Rejeição: Total do vISS difere do somatório do vProd dos itens sujeitos ao ISSQN");
                    break;
                case "606": mensagemAlerta("Rejeição: Total do vBC do ISS difere do somatório dos itens");
                    break;
                case "607": mensagemAlerta("Rejeição: Total do ISS difere do somatório dos itens");
                    break;
                case "608": mensagemAlerta("Rejeição: Total do PIS difere do somatório dos itens sujeitos ao ISSQN");
                    break;
                case "609": mensagemAlerta("Rejeição: Total do COFINS difere do somatório dos itens sujeitos ao ISSQN");
                    break;
                case "610": mensagemAlerta("Rejeição: Total da NF difere do somatório dos Valores compõe o valor Total da NF.");
                    break;
                case "611": mensagemAlerta("Rejeição: cEAN inválido");
                    break;
                case "612": mensagemAlerta("Rejeição: cEANTrib inválido");
                    break;
                case "613": mensagemAlerta("Rejeição: Chave de Acesso difere da existente em BD");
                    break;
                case "614": mensagemAlerta("Rejeição: Chave de Acesso inválida (Código UF inválido)");
                    break;
                case "615": mensagemAlerta("Rejeição:Chave de Acesso inválida (Ano < 05 ou Ano maior que Ano corrente)");
                    break;
                case "616": mensagemAlerta("Rejeição: Chave de Acesso inválida (Mês< 1 ouMês > 12)");
                    break;
                case "617": mensagemAlerta("Rejeição: Chave de Acesso inválida (CNPJ zerado ou dígito inválido)");
                    break;
                case "618": mensagemAlerta("Rejeição: Chave de Acesso inválida (modelo diferente de 55)");
                    break;
                case "619": mensagemAlerta("Rejeição: Chave de Acesso inválida (número NF = 0)");
                    break;
                case "620": mensagemAlerta("Rejeição: Chave de Acesso difere da existente em BD");
                    break;
                case "621": mensagemAlerta("Rejeição: CPF Emitente não cadastrado");
                    break;
                case "622": mensagemAlerta("Rejeição: IE emitente não vinculada ao CPF");
                    break;
                case "623": mensagemAlerta("Rejeição: CPF Destinatárionão cadastrado");
                    break;
                case "624": mensagemAlerta("Rejeição: IE Destinatárionão vinculada ao CPF");
                    break;
                case "625": mensagemAlerta("Rejeição: Inscrição SUFRAMA deve ser informada na venda com isenção para ZFM");
                    break;
                case "626": mensagemAlerta("Rejeição: O CFOP de operação isenta para ZFM deve ser 6109 ou 6110");
                    break;
                case "627": mensagemAlerta("Rejeição: O valor do ICMS desonerado deve ser informado");
                    break;
                case "628": mensagemAlerta("Rejeição: Total da NF superior ao valor limite estabelecido pela SEFAZ [Limite]");
                    break;
                case "629": mensagemAlerta("Rejeição: Valor  do  Produtodifere  do  produto Valor  Unitário  de  Comercializaçãoe Quantidade Comercial");
                    break;
                case "630": mensagemAlerta("Rejeição: Valor  do  Produtodifere do produto Valor Unitário de Tributação e Quantidade Tributável");
                    break;
                case "635": mensagemAlerta("Rejeição: NF-e com mesmo número e série já transmitida e aguardando processamento");
                    break;
                //denegação de uso
                case "301": mensagemAlerta("Uso Denegado: Irregularidade fiscal do emitente");
                    break;
                case "302": mensagemAlerta("Uso Denegado: Irregularidade fiscal do destinatário");
                    break;
                case "999": mensagemAlerta("Rejeição: Erro não catalogado. Código do erro: " + codigoMensagem);
                    break;
            }
            return false;
        }
